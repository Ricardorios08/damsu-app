...
<FORM ACTION="entrada_factura_4.php" METHOD = "POST" enctype="multipart/form-data" name="form">
  ...
  <table width="800" border="0" cellspacing="0">
        <tr bgcolor="#000099">
          <td height="35" colspan="3" bgcolor="#CCCCCC"><div align="center" class="Estilo16 Estilo54">INFORMAR ESTADO DE PRODUCTO  ANMAT </div></td>
        </tr>
        <tr bgcolor="#E6E6E6">
          <td width="37%" bgcolor="#E6E6E6"><div align="right" class="Estilo55"><span class="Estilo53">OPERADOR</span></div></td>
          <td width="63%" colspan="2" bgcolor="#E6E6E6"><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26"><span class="Estilo53"><span class="Estilo16"><span class="Estilo3"><span class="Estilo4 Estilo6 Estilo55"><span class="Estilo57">
        ...
        <tr bgcolor="#E8DCFC">
          <td bgcolor="#E6E6E6"><div align="right" class="Estilo57">EVENTO</div></td>
          <td colspan="2" bgcolor="#E6E6E6"><select name="evento[]">
            <!-- <option value="83">C&oacute;digo deteriorado/Destruido</option>
            <option value="33">Destrucci&oacute;n Medicamento por Vencimiento</option>
            <option value="82">Envio de Producto en caracter de devoluci&oacute;n</option>
            <option value="108">Recepci&oacute;n de producto en caracter de devoluci&oacute;n</option>
            <option value="148">Producto destinado a Exportaci&oacute;n</option>
            <option value="29">Recepci&oacute;n de productos en caracter de devoluci&oacute;n por prohibici&oacute;n</option> -->


			<option value="85">PRODUCTO ROBADO O EXTRAVIADO</option>
			<option value="97">PRODUCTO DESTRUIDO POR VTO</option>
