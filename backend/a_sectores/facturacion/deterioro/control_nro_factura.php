...
$vencimiento= "01/09/2013";

$n_factura = 1;
$hora =  gmdate('H:i', hora_local(-3));

$args[$a]["f_evento"] = "$fecha";
$args[$a]["h_evento"] = "$hora";
$args[$a]["gln_origen"] = "$user";
//$args[$a]["gln_destino"] = "$ace";

$args[$a]["lote"] = "a";
$args[$a]["vencimiento"] = "$vencimiento";
$args[$a]["numero_serial"] = "$nro_serie";
$args[$a]["n_factura"] = "$n_factura";
$args[$a]["desde_numero_serial"] = "1";
$args[$a]["hasta_numero_serial"] = "20";

$args[$a]["gtin"] = "$gtin";
$args[$a]["id_evento"] = "$evento1";
