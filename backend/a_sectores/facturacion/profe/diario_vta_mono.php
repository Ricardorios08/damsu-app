...
<table width="800" height="145" border="1" cellspacing="0">
  ...
  <tr valign="middle" bgcolor="#000099">
    <td height="26" colspan="5" bgcolor="#FFFFFF" >
      <div align="center" class="Estilo76">PROFE MONOCLONALES <?php ECHO $fecha_a;?></div>
      </div></td>
  </tr>
   <tr bgcolor="#DAFAFC">
...
$sql="select * from tr_ventas_encabezado where fecha between '$fecha_desde' and '$fecha_hasta' and nro_os = 10 AND NRO_FACTURA != 167678 ORDER by nro_factura, fecha desc";
