...
/*
$sql="select * from tr_ventas_encabezado where fecha between '$fecha_desde' and '$fecha_hasta' and nro_os = 10 group by nro_factura";
...
echo $sql2 = "UPDATE tr_ventas_detalle SET `nro_os` = '10' WHERE `nro_factura` = $nro_factura";
mysql_query($sql2);
echo "<br>";
...
<table width="800" height="206" border="1" cellspacing="0">
  <!--DWLayoutTable-->
