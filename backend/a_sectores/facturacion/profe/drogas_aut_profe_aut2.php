...
$titulo1= "Drogas Autorizadas por PROFE";
...
$sql = "INSERT into profe_detalle SELECT * FROM `tr_ventas_detalle` where cod_droga = '$cod_droga' and fecha > '2014-12-31' and nro_os = 10 and afectada = 0 order by cod_droga, nro_factura";
mysql_query($sql);
...
$hasta1  =$anio."-".$mes."-31";
  ...
  $sql11 = "SELECT *  FROM profe_detalle where fecha between '$desde1' and '$hasta1' and cod_droga = '$cod_droga' and nro_os = 10 and no_profe != 1";
...
$pdf->Cell(160,5,"TOTAL CONSUMO: ",1,0); 
$pdf->Cell(30,5,number_format($total_mes1,2),1,0,R); 
$pdf->Output();
