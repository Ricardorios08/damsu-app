...
<body onload = "on_load ()">
<FORM ACTION="cambiar_profe_mon.php" METHOD = "POST" enctype="multipart/form-data" name="form">



  <table width="800" border="0" cellspacing="0">
        <tr bgcolor="#000099">
          <td height="35" colspan="3" bgcolor="#CCCCCC"><div align="center" class="Estilo16 Estilo54">AGREGAR PROFE MONOCLONALES A UNA ENTREGA REALIZADA </div></td>
        </tr>
