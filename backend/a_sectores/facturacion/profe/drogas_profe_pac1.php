...
<table width="1063" border="0" cellpadding="0">
  <tr>
    <th colspan="2" bgcolor="#3399FF" scope="col"><span class="Estilo19">Paciente</span></th>
    <th width="216" bgcolor="#3399FF" scope="col"><span class="Estilo19">Direccion </span></th>
    <th width="148" bgcolor="#3399FF" scope="col"><span class="Estilo19">Localidad</span></th>
	    <th width="83" bgcolor="#3399FF" scope="col"><span class="Estilo19">Ingreso</span></th>
		    <th width="274" bgcolor="#3399FF" scope="col"><span class="Estilo19">Diagnóstico</span></th>
  </tr>
...
?>
<tr>
    <td width="221"><div align="left" class="Estilo16"><?php echo $apellido;?>, <?php echo $nombre;?></div></td>
    <td width="84"><span class="Estilo16"> <?php echo $documento;?></span></td>
