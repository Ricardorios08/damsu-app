...
<table width="800" height="145" border="1" cellspacing="0">
  ...
  <tr valign="middle" bgcolor="#000099">
    <td height="26" colspan="6" bgcolor="#CCCCCC"><div align="center">DEVOLUCIONES (Ingreso al Unico) </div></td>
  </tr>
  <tr valign="middle" bgcolor="#000099">
...
<td width="12%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">IMP</span></div></td>
   </tr>
...
<td><div align="center" class="Estilo5"> <div align="left"><?php print("$denominacion");?> <?php print("$nro_os");?></div>
</div>    </td>
...
<td><div align="center"><a href="../imprimir_nc_pdf_dev.php?nro_factura=<?php print("$nro_factura");?>" target = "central1"> <img src="../../../imagenes/logo Pdf.gif" width="32" height="23" alt="PDF" longdesc="PDF DESCARGAR"></a> </div></td>
...
$cuenta = "";
   ...
   <tr>
  <td height="21" colspan="6" bgcolor="#B8B8B8"><div align="right"><strong>TOTAL <span class="Estilo72">$ <?php echo number_format($total_total,2);?></span></strong></div>
