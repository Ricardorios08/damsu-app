...
<li><a href="../../a_sectores/gtin/entregas/pagina1.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&id=<?php print("$id");?>&&operador=<?php print("$id");?>&&band=1" target = 'central1'>A COIR</a></li>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><iframe src="../../../a_sectores/facturacion/tablas_entrega.php?cod_paciente=<?php print("$cod_paciente");?>&&tipo_doc=<?php print("$tipo_doc");?>" width="366
	
	" height="200" frameborder="0"> </iframe></td>
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><IFRAME src="../../../a_sectores/facturacion/tablas_entrega_damsu.php.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&cod_paciente=<?php print("$cod_paciente");?>&&operador=<?php print("$id");?>" width="395" height="200" frameborder="0"> </IFRAME></td>
  </tr>
