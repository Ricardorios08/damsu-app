...
<tr bgcolor="#B8B8B8">
	...
	<td width="107"><div align="center"><span class="Estilo3">ESTADO</span></div></td>
...
<tr bgcolor="#F0F0F0">
	...
	<td><div align="center">
	  <select name="<?php echo estados.$cod_detalle;?>[]" id="select2" onkeypress="return verif_caracter(this,event)">
        <option value selected= "<?php  echo $estado;?>"> <font size="2" face="Trebuchet MS"><strong><font color="#000000"><?php print("$estado");?></font></strong></font></option>
