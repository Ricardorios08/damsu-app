...
function deseleccionar_todo(){
   for (i=0;i<document.f1.elements.length;i++)
      if(document.f1.elements[i].type == "checkbox")
		...
		<form action="estados_oncologia_aplicado.php" name="f1" method="post" target = "central1">
...
<tr bgcolor="#B8B8B8">
	...
	<td width="271"><div align="center" class="Estilo3">DROGA</div></td>
	<td width="200"><div align="center" class="Estilo3">GTIN</div></td>
	<td width="39"><div align="center" class="Estilo3">LOTE</div></td>
	<td width="42"><div align="center" class="Estilo3">VTO</div></td>
	<td width="75"><div align="center" class="Estilo3">APLICADO</div></td>
		<td width="75"><div align="center" class="Estilo3">FECHA</div></td>
	</tr>
...
<?php
 ...
 $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  nro_factura = $nro_factura and recibido_servicio = 1 order by  cod_detalle desc";
...
$fecha_aplicado= $result3->fields["fecha_aplicado"];
...
if ($fecha_aplicado != '0000-00-00'){	
$di = substr($fecha_aplicado,8,2);$me = substr($fecha_aplicado,5,2);$an = substr($fecha_aplicado,0,4);$fecha_aplicado = $di."/".$me."/".$an;
}else{
$fecha_aplicado = " - ";
}
...
<tr bgcolor="#F0F0F0">
	...
	<td bgcolor="#F0F0F0"><div align="center"><span class="Estilo4"><?php echo $fecha_aplicado;?></span></div></td>
	<?php
