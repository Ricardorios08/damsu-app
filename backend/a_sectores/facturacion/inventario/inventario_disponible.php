...
<table width="800">
  <!--DWLayoutTable-->
    ...
    <tr bgcolor="#FFFFFF">
    <td colspan="8"><div align="center" class="Estilo5">INVENTARIO LISTO PARA DISPONIBILIDAD DESDE HACE 60 DIAS</div></td>
  </tr>
...
$desde =  date("Y-m-d",strtotime($fecha_actual."- 60 days")); 
  ...
  $sql3 = "SELECT tr_ventas_detalle.* , tr_ventas_encabezado.* , tr_ventas_encabezado.fecha as fecha5 FROM tr_ventas_detalle INNER JOIN tr_ventas_encabezado ON tr_ventas_detalle.nro_factura = tr_ventas_encabezado.nro_factura WHERE  tr_ventas_encabezado.fecha < '$desde' and tr_ventas_detalle.recibido_coir = 1 and tr_ventas_detalle.preparado_coir = 0 and tr_ventas_encabezado.enviar = '$id' and tr_ventas_detalle.disponible = 0 ORDER BY tr_ventas_encabezado.fecha , tr_ventas_encabezado.documento, tr_ventas_encabezado.nro_factura, tr_ventas_detalle.cod_mercaderia";
