...
<li><a href="diario_vta_coir_os/consultas.php" target = "central1" class="Estilo54" >2. Estados</a></li>
<!-- <li><a href="profe/consultas.php" target = "central1" class="Estilo54" >2. Planilla PROFE</a></li> -->
<!-- <li><a href="mes/consultas.php" target = "central1" class="Estilo54" >2. Planilla MENSUAL </a></li> -->
 <!-- <li><a href="diario_vta_envio_coir/consultas.php" target = "central1" class="Estilo54" >3. Planilla COIR </a></li>  	 -->
 <li><a href="inventario/inventario.php" target = "central1" class="Estilo54" >3. Inventario</a></li>  
  <li><a href="inventario/inventario_disponible.php" target = "central1" class="Estilo54" >4. Disponible</a></li>  
    <!-- <li><a href="inventario/elegir.php" data-target="#exampleModal" class="Estilo54" >6. Disponi Coir </a></li>   -->
    <li><a href="inventario/inventario_trazabilidad.php" target = "central1" class="Estilo54" >5. Trazabilidad</a></li> 
