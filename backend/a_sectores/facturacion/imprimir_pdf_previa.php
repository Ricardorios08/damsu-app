...
$this->SetFont('Arial','B',14);
 $this->Cell(80,6,"PREVIA NOTA DE ENTREGA",1,0,'C');
$this->SetY(16);
$this->SetX(155);
...
$pdf->SetFont('ARIAL','',8);
  ...
  $sql = "SELECT * FROM tr_ventas1_encab_temp where operador = $nro_factura";
...
$pdf->setFactura($nro_fact);
 ...
 $sql4 = "SELECT sum(precio_unitario) as neto FROM tr_ventas1_deta_temp  WHERE  operador = $nro_factura order by  cod_detalle desc";
...
$pdf->ln();
 ...
 $sql3 = "SELECT * FROM tr_ventas1_deta_temp  WHERE  operador = $nro_factura order by  cod_detalle desc";
...
//IF ($tipo_factura != "PO"){
	$pdf->SetX(22);
$pdf->Cell(80,5,"Comercial: ".$nombre_comercial,0); 
