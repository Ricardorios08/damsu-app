...
<li><a href="../proveeduria/informes.php" target = "izquierda" class="Estilo54" >7. ACTUALIZACIONES </a></li> -->
   ...
   <!-- <li><a href="nota_devolucion/entrada_nota.php?id=<?php print("$id");?>" target = "central1" class="Estilo54" >1. Devolución PO</a></li>  

  <li><a href="../facturacion_unico/cartel_anulada.php" target = "central1" class="Estilo54" >2. Cartel ANULADA</a></li>  
   <li><a href="profe/agregar_profe.php" target = "central1" class="Estilo54" >3. AGREGAR PROFE</a></li>  

 <li><a href="profe/sacar_profe.php" target = "central1" class="Estilo54" >4. SACAR PROFE</a></li>  

    <li><a href="profe/agregar_profe_mon.php" target = "central1" class="Estilo54" >5. AGREGAR MON PROFE</a></li>  
<li><a href="profe/sacar_profe_mon.php" target = "central1" class="Estilo54" >6. SACAR MON PROFE</a></li>  -->


<li><a href="profe/agregar_coir.php" target = "central1" class="Estilo54" >1. AGREGAR COIR</a></li> 
<li><a href="profe/sacar_coir.php" target = "central1" class="Estilo54" >2. SACAR COIR</a></li> 


 <!-- <li><a href="profe/consumo_profe_paciente_coope.php" target = "central1" class="Estilo54" >8. CONS.PACI AUT (coope)</a></li>  -->
 ...
 <li><a href="profe/drogas_profe_pac1.php" target = "central1" class="Estilo54" >9. PACIENTES DE PROFE</a></li>  
<li><a href="profe/drogas_profe_pac1_diagnostico.php" target = "central1" class="Estilo54" >9. PAC. PROFE DIAIGNOSTICO</a></li>  
<li><a href="profe/consumo_profe.php" target = "central1" class="Estilo54" >10. CONSUMO X DROGAS AUT</a></li>  
<li><a href="profe/consumo_profe_paciente.php" target = "central1" class="Estilo54" >11. CONSUMO PACIENTE AUT</a></li>  
...
<table width="166"  border="0">
  ...
  <tr>
   ...
   <form action="../facturacion_unico/imprimir_pdf.php" method="post" target = "central1">
<table width="166"  border="0">

  <tr>
    <td bgcolor="#666666"><div align="center" class="titulo">DEVOLUCIONES</div></td>
  </tr>
