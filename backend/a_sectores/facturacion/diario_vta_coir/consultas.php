...
<FORM ACTION="separar_busqueda.php" method="post" TARGET = "central1">
 <input name = "id" type = "hidden" id="id" value = "<?php echo $id;?>" size = "2" maxlength = "2">


<table width="75%" border="0">
  <tr bgcolor="#B8B8B8">
    <td height="28" colspan="2" align="center" scope="row"><div align="center"><span class="Estilo13">RECIBIDOS  </span></div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
$sql="select * from tr_ventas_encabezado where fecha between '$fecha_d' and '$fecha_h' and enviar = '$id' group by fecha";
