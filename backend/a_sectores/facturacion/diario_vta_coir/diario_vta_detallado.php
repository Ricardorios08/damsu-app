...
<tr valign="middle" bgcolor="#F0F0F0">
    <td height="26" colspan="9"><div align="center" class="Estilo74"><strong>ENVIOS: <?php ECHO $fecha_a;?></strong></div></td>
  </tr>
   <tr bgcolor="#DAFAFC">
...
include ("../../../conexiones/config_pro.php");
   ...
   $sql="select * from tr_ventas_encabezado where fecha = '$fecha' and enviar = '$id'  ORDER by nro_factura, fecha desc";
...
<td><div align="center" class="Estilo75"><a href="../buscar_paciente_general_coir.php?documento=<?php print("$cuenta");?>&&bander=2&&busca=<?php print("$cuenta");?>" target = "central1"><?php print("$cuenta");?></a></div></td>
...
<?php
 ...
 <tr bgcolor="#FFFFFF">
     ...
     <td height="21" colspan="6"><?php include ("detalle_factura_r.php");?></td>
  </tr>
   <tr bgcolor="#FFFFFF">
     <td height="21"><!--DWLayoutEmptyCell-->&nbsp;</td>
     <td height="21" colspan="6"><!--DWLayoutEmptyCell-->&nbsp;</td>
   </tr>
