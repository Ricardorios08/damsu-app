...
<tr valign="middle" bgcolor="#F0F0F0">
    <td height="26" colspan="9"><div align="center" class="Estilo2">
      <div align="center"><span class="Estilo74"><strong>ENVIOS: <?php ECHO $fecha_a;?></strong></span></div>
    </div></td>
  </tr>
   <tr bgcolor="#DAFAFC">
...
include ("../../../conexiones/config_pro.php");
 ...
 ECHO $sql="select * from tr_ventas_encabezado where fecha = '$fecha' and enviar = '$id' and fuente = '$fuente' ORDER by nro_factura, fecha desc";
