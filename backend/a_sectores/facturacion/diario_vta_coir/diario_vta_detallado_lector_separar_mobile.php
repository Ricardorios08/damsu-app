...
<FORM ACTION="diario_vta_detallado_lector_separar.php?nro_paciente=<?php print("$nro_paciente");?>" method="post" >


<table width="100%" border="0" cellspacing="0">
  <!--DWLayoutTable-->
<tr valign="middle" bgcolor="#F0F0F0">
    <td colspan="9"><div align="center" class="Estilo74"><strong>RECIBIR MONODROGAS POP: <?php ECHO $fecha_a;?></strong></div></td>
  </tr>
...
<tr valign="middle" bgcolor="#F0F0F0">
  <td colspan="9"><iframe src="diario_vta_detallado_lector.php?fecha=<?php print("$fecha");?>" width="900" height="600" frameborder="0"></iframe></td>
</tr>
</table>
