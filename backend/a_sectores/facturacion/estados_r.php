...
$cont = $cont + 1;
   ...
   $sql1 = "UPDATE `tr_ventas_detalle` SET `fecha_recibido` = '$hoy_g'  WHERE `cod_detalle` = '$cod_detalle' and recibido_coir = 0";
$result1 = $db->Execute($sql1);


    $sql1 = "UPDATE `tr_ventas_detalle` SET `recibido_coir` = '$estado_guardar'  WHERE `cod_detalle` = '$cod_detalle' and indicado_coir = 0";
$result1 = $db->Execute($sql1);
