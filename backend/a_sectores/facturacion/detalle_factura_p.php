...
$cod_detalle1111 = $cod_detalle;
	  ...
	  if ($preparado_coir == 1){?>
	<input type="checkbox" name="<?php echo control.$cod_detalle;?>" value ="<?php echo $cod_detalle1111;?>" checked id="caja14" onClick="ajax1(this);"/>
	<?php }else{?>
	<input type="checkbox" name="<?php echo control.$cod_detalle;?>"  value ="<?php echo $cod_detalle1111;?>" id="caja14" onClick="ajax1(this);"/>
	<?php }
