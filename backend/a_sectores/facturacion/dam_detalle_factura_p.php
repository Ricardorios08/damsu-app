...
-->
		...
		<form action="estados_p.php" name="f1" method="post" target = "central1">
...
<table width="850">
<tr bgcolor="#6499CB">
  <td colspan="4"><div align="center" class="Estilo1">PREPARACION DE MERCADERIA </div></td>
  </tr>
<tr>
...
<tr bgcolor="#B8B8B8">
	...
	<td width="103"><div align="center" class="Estilo3">PREPARADA</div></td>
...
<?php
 ...
 $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  nro_factura = $nro_factura AND indicado_coir = 1 order by  cod_detalle desc";
...
<tr bgcolor="#F0F0F0">
	...
	<td><div align="center" class="Estilo4"> 
      ...
      <!-- <input type="checkbox" name="<?php echo estudios2.$cod_grabacion;?>" value ="<?php echo $cod_grabacion;?>" id="caja14" onclick="ajax1(this);"/> -->


		<?php

$cod_detalle1111 = $cod_detalle;
		
		if ( $recibido_farmacia == 1){
	
			?><input type="checkbox" name="<?php echo control.$cod_detalle;?>" value ="<?php echo $cod_detalle1111;?>" checked  disabled id="caja14"  onClick="ajax1(this);"/><?php
		
		
		}else{ 

	  if ($preparado_coir == 1){?>
	<input type="checkbox" name="<?php echo control.$cod_detalle;?>" value ="<?php echo $cod_detalle1111;?>" disabled checked id="caja14" onClick="ajax1(this);"/>
	<?php }else{?>
	<input type="checkbox" name="<?php echo control.$cod_detalle;?>"  value ="<?php echo $cod_detalle1111;?>" id="caja14" disabled onClick="ajax1(this);"/>
	<?php }
...
<?php $di = substr($fecha_preparado,8,2);$me = substr($fecha_preparado,5,2);$an = substr($fecha_preparado,0,4);$fecha_preparado = $di."/".$me."/".$an;?>



	<?php if ($preparado_coir == 1){?>
	<td><div align="center" class="Estilo4"><?php echo $fecha_preparado;?></div></td>
	<?php }else{?>
