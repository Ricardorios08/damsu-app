...
mysql_query($sql);
  ...
  $sql = "DELETE FROM `tr_ventas_encabezado_temp` WHERE operador = $operador";
mysql_query($sql);
...
$nombre_diagnostico=strtoupper($result->fields["nombre_diagnostico"]); 
 ...
 $sql = "INSERT INTO `tr_ventas1_encab_temp` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `nro_receta` , `documento` , `tipo_doc` , `plan` , `operador` , `denominacion` , `fecha` , `forma_pago` , `porc_dto` , `nombre_operador` , `nro_os` , `nombre_os` , `observaciones`  ,  `departamento`  ,  `cod_diagnostico`  ,  `cod_agrupado` ,  `enviar` ) VALUES ( 'x'  , '$operador' , '$cod_operacion' , '$nro_receta' , '$documento' , '$tipo_doc' , '' , '$operador' , '$nombre_completo' , '$fecha' , '' , '' , '$nombre_operador' , '$nro_os' , '$nombre_os' , '$observaciones' ,  '$departamento' ,  '$cod_diagnostico' ,  '$cod_agrupado' , '$enviar' )";
mysql_query($sql);

   $sql = "INSERT INTO `tr_ventas_encabezado_temp` (`tipo_fact`, `nro_factura`, `nro_receta`, `documento`, `tipo_doc`, `plan`, `operador`, `denominacion`, `fecha`, `forma_pago`, `porc_dto`, `nombre_operador`, `nro_os`, `nombre_os` , `neto` , `cod_movimiento`) VALUES ( 'x'  , '' , '$nro_receta' , '$documento' , '$tipo_doc' , '' , '$operador' , '$nombre_completo' , '$fecha' , '' , '' , '$nombre_operador' , '$nro_os' , '$sigla', '' , '1' )";
mysql_query($sql);
