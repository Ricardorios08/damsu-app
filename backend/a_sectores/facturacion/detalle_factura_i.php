...
-->
		...
		<form action="estados_i.php" name="f1" method="post" target = "central1">
...
<table width="850">
<tr bgcolor="#FE9900">
  <td colspan="4"><div align="center" class="Estilo1">MERCADERIA INDICADA A PACIENTES</div></td>
  </tr>
<tr>
...
<tr bgcolor="#B8B8B8">
	...
	<td width="103"><div align="center" class="Estilo3">INDICADA</div></td>
...
<?php
 ...
 $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  nro_factura = $nro_factura and recibido_coir > 0   order by  cod_detalle desc";
...
<?php $di = substr($fecha_indicado,8,2);$me = substr($fecha_indicado,5,2);$an = substr($fecha_indicado,0,4);$fecha_indicado = $di."/".$me."/".$an;?>


	<?php if ($indicado_coir == 1){?>
	<td><div align="center" class="Estilo4"><?php echo $fecha_indicado;?></div></td>
	<?php }else{?>
