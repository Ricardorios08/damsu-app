...
$result2 = $db->Execute($sql2);
 $sigla=strtoupper($result2->fields["sigla"]);
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="2" bgcolor="#69FF62"><div align="center"><span class="Estilo7">COIR</span></div></td>
    <td bgcolor="#FFFFFF"><!--DWLayoutEmptyCell-->&nbsp;</td>
    <td colspan="3" valign="top" bgcolor="#C463FE"><div align="center" class="Estilo1 Estilo8">SERVICIO DE FARMACIA </div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><iframe src="tablas_entrega_coir_recibido.php?cod_paciente=<?php print("$cod_paciente");?>&&tipo_doc=<?php print("$tipo_doc");?>" width="395" height="500" frameborder="0"> </iframe></td>
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><IFRAME src="tablas_entrega_farmacia.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&cod_paciente=<?php print("$cod_paciente");?>&&operador=<?php print("$id");?>" width="395" height="500" frameborder="0"> </IFRAME></td>
  </tr>
