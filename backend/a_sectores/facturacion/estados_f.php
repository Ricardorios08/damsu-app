...
$cont = $cont + 1;
   ...
   $sql1 = "UPDATE `tr_ventas_detalle` SET `recibido_farmacia` = '$estado_guardar' , `fecha_farmacia` = '$hoy_g'  WHERE `cod_detalle` = '$cod_detalle'";
...
$bander = 1;
include ("detalle_factura_f1.php");

}ELSE
{
$bander = 1;
$palabra = $documento;
include ("buscar_paciente_general_servicio.php");
}
?>
