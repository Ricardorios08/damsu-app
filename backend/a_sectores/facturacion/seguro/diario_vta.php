...
<tr valign="middle" bgcolor="#CEFFCE">
    <td height="45" colspan="9"><div align="center" class="Estilo2 Estilo18">
	...
	<td width="218"><div align="center" class="Estilo3 Estilo16 Estilo5">DROGA</div>	  <div align="center"></div></td>
	<td width="131"><div align="center" class="Estilo3 Estilo16 Estilo5">GTIN</div></td>
	<td width="42"><div align="center" class="Estilo3 Estilo16 Estilo5">LOTE</div></td>
	<td width="52"><div align="center" class="Estilo3 Estilo16 Estilo5">UNITARIO</div></td>
...
$sql3=" SELECT tr_ventas_detalle.*, tr_ventas_encabezado.fuente, tr_ventas_encabezado.nombre_fuente  FROM tr_ventas_detalle INNER JOIN tr_ventas_encabezado ON tr_ventas_detalle.nro_factura = tr_ventas_encabezado.nro_factura where tr_ventas_detalle.$fecha_sel between '$desde' and '$hasta' and tr_ventas_detalle.$estado = $valor and tr_ventas_encabezado.fuente = '$fuente' "; 
...
<tr bgcolor="#F0F0F0">
  ...
  <td><span class="Estilo4 Estilo16 Estilo5"> <?php echo $nombre_completo;?><br> DNI:  <?php echo $documento;?></span></td>
<td><div align="center"><span class="Estilo4 Estilo16 Estilo5"> <?php echo $cantidad;?></span></div></td>
	<td><span class="Estilo4 Estilo16 Estilo5"><?php echo $droga;?><br><?php echo $nombre_comercial;?></span></td>
	<td><span class="Estilo4 Estilo16 Estilo5"><?php echo $gtin;?></span></td>
	<td><div align="center" class="Estilo4 Estilo16 Estilo5"><?php echo $lote1;?><br><?php echo $vto_lote;?></div></td>
...
<tr bgcolor="#F0F0F0">
  <td colspan="6"><div align="right"><span class="Estilo16"></span></div>    
  ...
  <td colspan="2"><div align="right"><span class="Estilo16"><strong>TOTAL: </strong></span><span class="Estilo17"><span class="Estilo4 Estilo16 Estilo19"><?php echo $total_total;?></span></span></div></td>
</table>
