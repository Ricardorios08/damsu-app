...
<table width="100%" height="145" border="0" cellspacing="0">
  <!--DWLayoutTable-->
<tr valign="middle" bgcolor="#F0F0F0">
    <td height="26" colspan="9"><div align="center" class="Estilo74"><strong>ENVIOS POP: <?php ECHO $fecha_a;?></strong></div></td>
  </tr>
   <tr bgcolor="#DAFAFC">
