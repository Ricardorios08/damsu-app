...
<tr bgcolor="#B8B8B8">
	<td width="43"><div align="center" class="Estilo1 Estilo2 Estilo3 Estilo4">CANT</div></td>
	<td><div align="center" class="Estilo5">DROGA</div></td>
	<td width="207"><div align="center" class="Estilo5">GTIN</div></td>
	<td width="45"><div align="center" class="Estilo5">LOTE</div></td>
	<td width="41"><div align="center" class="Estilo5">VTO</div></td>
	<td width="49"><div align="center"><span class="Estilo1 Estilo2 Estilo3 Estilo4">FECHA</span></div></td>
    <td width="18">&nbsp;</td>
</tr>
...
$dia2 = substr($fecha_recibido,8,2);
$mes2 = substr($fecha_recibido,5,2);
$anio2 = substr($fecha_recibido,0,4);
$fecha_recibido = $dia2."/".$mes2."/".$anio2;
...
<tr bgcolor="#FFFFFF">
	...
	<td><span class="Estilo5"><?php echo $nombre_comercial;?></span>	  <div align="center"></div></td>
	...
	<td><div align="center"><span class="Estilo5"><?php echo $fecha_recibido;?></span></div></td>
	<td><div align="center"><img src="tilde.jpg" width="18" height="20"></div></td>
	<?PHP
 }else{
?>
<tr bgcolor="#FFFFFF">
	<td><div align="center" class="Estilo5"><?php echo $cantidad;?> </div></td>
	<td><span class="Estilo5"><?php echo $nombre_comercial;?></span></td>
	<td><span class="Estilo5"><?php echo $gtin;?></span></td>
	<td><div align="center" class="Estilo5"><?php echo $lote1;?></div></td>
	<td><div align="center" class="Estilo5"><?php echo $vto_lote;?></div></td>
	<td>&nbsp;</td>
