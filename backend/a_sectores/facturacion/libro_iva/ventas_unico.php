...
echo $sql="select * from ventas_encabezado where fecha BETWEEN '$fecha_desde' and '$fecha_hasta' ORDER by $ordenar";
...
?>
     ...
     <td><span class="Estilo20">002 - <?php print("$nro_factura");?></span></td>
