...
$pdf->Cell(50,5,$nombre_completo1,0); 
$pdf->SetFont('ARIAL','',8);

$pdf->SetFont('ARIAL','B',12);
$pdf->SetX(140);
$pdf->Cell(50,5,$tipo_factura11,0); 
$pdf->SetFont('ARIAL','',8);

$pdf->ln();
$pdf->Cell(18,5,"Documento: ",0); 
$pdf->SetFont('ARIAL','B',10);
$pdf->Cell(50,5,$documento1,0); 
$pdf->SetFont('ARIAL','',8);
$pdf->SetX(80);
$pdf->Cell(50,5,"Registro de Tumor: ".$nro_ficha1,0); 
$pdf->ln();

$pdf->Cell(15.5,5,"Domicilio: ",0); 
$pdf->Cell(50,5,$direccion1,0); 


$pdf->SetFont('ARIAL','B',12);
$pdf->SetX(120);

$pdf->Cell(50,5,$nombre_os1,0); 
$pdf->SetFont('ARIAL','',8);
$pdf->ln();
...
/*
 $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  nro_factura = $nro_factura order by cod_mercaderia, cod_detalle desc";
