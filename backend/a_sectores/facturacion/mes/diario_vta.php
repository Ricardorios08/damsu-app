...
<?php if ($cod_fuente == ""){?>
    <td height="26" colspan="5" bgcolor="#CCCCCC"><div align="center">CONSUMO POR PACIENTE MENSUAL</div></td>
<?php }else{?>

   <td height="26" colspan="5" bgcolor="#CCCCCC"><div align="center">CONSUMO POR PACIENTE MENSUAL <?PHP echo $nombre_fuente;?></div></td>
   <?php }?>
...
if ($cod_fuente == ""){
$sql="select * from tr_ventas_encabezado where fecha between '$fecha_desde' and '$fecha_hasta'  ORDER by nro_factura, fecha desc";
}else{
$sql="select * from tr_ventas_encabezado where fecha between '$fecha_desde1' and '$fecha_hasta1' and forma_pago = '$cod_fuente' ORDER by nro_factura, fecha desc";
}
...
$sql2="select COUNT(DISTINCT documento) as cant_pacientes from tr_ventas_encabezado where fecha between '$fecha_desde' and '$fecha_hasta' and nro_os = 10";
