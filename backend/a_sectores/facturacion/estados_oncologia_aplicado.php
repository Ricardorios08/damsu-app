...
$cont = $cont + 1;
     ...
     $sql1 = "UPDATE `tr_ventas_detalle` SET  `fecha_aplicado` = '$hoy_g'  WHERE `cod_detalle` = '$cod_detalle'";
$result1 = $db->Execute($sql1);

   $sql1 = "UPDATE `tr_ventas_detalle` SET aplicado_servicio = '$estado_guardar'  WHERE `cod_detalle` = '$cod_detalle' "; 
$result1 = $db->Execute($sql1);
 ...
 $sql1 = "UPDATE `tr_ventas_detalle` SET `fecha_aplicado` = '' WHERE `nro_factura` = '$nro_factura' AND aplicado_servicio = 0";
$result1 = $db->Execute($sql1);


$bander = 1;
include ("detalle_factura_oncologia_aplicado.php");
