...
.Estilo4 {font-size: 16px; font-family: Geneva, Arial, Helvetica, sans-serif; }
.Estilo7 {font-size: 12px}
.Estilo8 {font-size: 12px; font-family: Arial, Helvetica, sans-serif; }
-->
    </style>
    
	

		<form action="estados_p.php" method="post" target = "central1">
...
<table width="850">
<tr bgcolor="#6499CB">
  <td colspan="4"><div align="center" class="Estilo1">ESTADOS DE MERCADERIA </div></td>
  </tr>
<tr>
...
<tr bgcolor="#B8B8B8">
  ...
  <td colspan="2" bgcolor="#69FF62"><div align="center"><strong><span class="Estilo8">COIR</span></strong></div></td>
  <td colspan="2" bgcolor="#C463FE"><div align="center" class="Estilo8"><strong>HOSPITAL</strong></div></td>
  </tr>
<tr bgcolor="#B8B8B8" class="Estilo2">
	<td width="34"><div align="center" class="Estilo1 Estilo2  Estilo7">CANT</div></td>
	<td width="265"><div align="center" class="Estilo8">DROGA</div></td>
	<td width="187"><div align="center" class="Estilo8">GTIN</div></td>
	<td width="45"><div align="center" class="Estilo8">LOTE</div></td>
	<td width="37"><div align="center" class="Estilo8">VTO</div></td>
	<td width="54"><span class="Estilo8">RECIBIDO</span></td>
	<td width="72"><span class="Estilo8">PREPARADO</span></td>
	<td width="59"><span class="Estilo8">FARMACIA</span></td>
	<td width="57" class="Estilo8">SERVICIO</td>
</tr>
...
$fecha_farmacia= $result3->fields["fecha_farmacia"];
$fecha_servicio= $result3->fields["fecha_servicio"];
 	 	
 $indicado_coir= $result3->fields["indicado_coir"];

 $recibido_coir= $result3->fields["preparado_coir"];
...
if ($fecha_preparado != '0000-00-00'){
$di = substr($fecha_preparado,8,2);$me = substr($fecha_preparado,5,2);$an = substr($fecha_preparado,0,4);$fecha_preparado = $di."/".$me."/".$an;
}else{
$fecha_preparado = " - ";
}

if ($fecha_farmacia != '0000-00-00'){
$di = substr($fecha_farmacia,8,2);$me = substr($fecha_farmacia,5,2);$an = substr($fecha_farmacia,0,4);$fecha_farmacia = $di."/".$me."/".$an;
}else{
$fecha_farmacia = " - ";
}

if ($fecha_servicio != '0000-00-00'){	
$di = substr($fecha_servicio,8,2);$me = substr($fecha_servicio,5,2);$an = substr($fecha_servicio,0,4);$fecha_servicio = $di."/".$me."/".$an;
}else{
$fecha_servicio = " - ";
}
...
<tr bgcolor="#F0F0F0">
	...
	<td><div align="center" class="Estilo4"><?php echo $fecha;?> 
	
	</div></td>
	<td><div align="center"><span class="Estilo4"><?php echo $fecha_preparado;?></span></div></td>
	<td><div align="center"><span class="Estilo4"><?php echo $fecha_farmacia;?></span></div></td>
	<td><div align="center"><span class="Estilo4"><?php echo $fecha_servicio;?></span></div></td>
	<?php
