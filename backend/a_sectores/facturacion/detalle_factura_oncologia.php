...
-->
		...
		<form action="estados_oncologia.php" name="f1" method="post" target = "central1">
...
<tr>
    ...
    <td width="339" bgcolor="#F0F0F0">&nbsp;</td>
</tr>
<tr>
	<td bgcolor="#B8B8B8"><span class="Estilo4">Fuente:</span></td>
	<td colspan="2" bgcolor="#F0F0F0"><span class="Estilo4"><?php echo $fuente;?></span></td>
</tr>
<tr>
	<td bgcolor="#B8B8B8"><span class="Estilo4">Documento: </span></td>
	<td colspan="2" bgcolor="#F0F0F0"><span class="Estilo4"><?php echo $documento;?></span></td>
</tr>
</table>
...
<tr bgcolor="#B8B8B8">
	<td width="43"><div align="center" class="Estilo1 Estilo2">CANT</div></td>
	<td width="271"><div align="center" class="Estilo3 Estilo1 Estilo2">DROGA</div></td>
	<td width="200"><div align="center" class="Estilo3 Estilo1 Estilo2">GTIN</div></td>
	<td width="39"><div align="center" class="Estilo3 Estilo1 Estilo2">LOTE</div></td>
	<td width="42"><div align="center" class="Estilo3 Estilo1 Estilo2">VTO</div></td>
	<td width="75"><div align="center" class="Estilo3 Estilo1 Estilo2">CONTROL</div></td>
	<td width="75"><div align="center" class="Estilo3">RECIBIDO</div></td>
</tr>
...
<?php
 ...
 $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  nro_factura = $nro_factura and recibido_farmacia = 1 order by  cod_detalle desc";
...
<tr bgcolor="#F0F0F0">
	...
	<td><div align="center" class="Estilo4"> 
	 ...
	 if ($recibido_servicio == 1){?>
	<input type="checkbox" name="<?php echo control.$cod_detalle;?>" checked id="caja14" onclick="ajax1(this);"/>
	<?php }else{?>
	<input type="checkbox" name="<?php echo control.$cod_detalle;?>"  id="caja14" onclick="ajax1(this);"/>
	<?php }
	...
	<td bgcolor="#F0F0F0"><div align="center"><span class="Estilo4"><?php echo $fecha_servicio;?></span></div></td>
	<?php
