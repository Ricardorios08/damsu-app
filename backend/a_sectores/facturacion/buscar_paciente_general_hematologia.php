...
$result2 = $db->Execute($sql2);
 $sigla=strtoupper($result2->fields["sigla"]);
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
	...
	<div id="menuh">
		<ul>
			<li><a href="ficha.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>HISTORIA CLINICA</a>
			  <!-- <li><a href="../a_pacientes/modificar_pacientes.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>MODIFICAR PACIENTE</a></li>
		</ul> -->
		    </li>	</td>
  </tr>
  <!-- <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="2" bgcolor="#62B0FF"><div align="center"><span class="Estilo1">COIR</span></div></td>
    <td bgcolor="#FFFFFF"><!--DWLayoutEmptyCell-->&nbsp;</td>
    <td colspan="3" valign="top" bgcolor="#62B0FF"><div align="center" class="Estilo1">SERVICIO DE FARMACIA </div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><table width="366" height="24" border="0" align="center" cellspacing="0">
      <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    ...
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><table width="366" height="24" border="0" align="center" cellspacing="0">
      <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
        <td width="84" bgcolor="#CCCCCC"><div align="center"><font size="2" face="Trebuchet MS">Comp.</font></div></td>
        <td width="54" height="24" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Fecha</font></div></td>
        <td width="69" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Importe</font></div></td>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    ...
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><IFRAME src="tablas_entrega.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&cod_paciente=<?php print("$cod_paciente");?>&&operador=<?php print("$id");?>" width="395" height="200" frameborder="0"> </IFRAME></td>
  </tr>
