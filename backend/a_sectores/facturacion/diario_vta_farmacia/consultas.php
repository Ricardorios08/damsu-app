...
<table width="75%" border="0">
  <tr bgcolor="#B8B8B8">
    <td colspan="2" align="center" scope="row"><div align="center"><span class="Estilo13">ENVIOS COIR </span></div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="center" scope="row"><div align="left" class="Estilo16">
        ...
        <span class="Estilo17"> DETALLE X MERCADERIA        </span></div></td>
  </tr>
  <tr bgcolor="#F0F0F0">
    <td align="center" scope="row"><span class="Estilo16"><span class="Estilo17">
      </span></span></td>
...
<table width="75%" height="21%" border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#B8B8B8">
    <td height="50%" colspan="12" bgcolor="#F0F0F0"><div align="center" class="Estilo14"><span class="Estilo13">MEDICACION PREPARADA EN COIR </span></div></td>
  </tr>
 <tr>
<?PHP 
...
$fecha_h = $anio."-".$mes."-31";
  ...
  $sql="select * from tr_ventas_detalle where fecha_preparado  between '$fecha_d' and '$fecha_h'  and preparado_coir = 1 group by fecha_indicado order by fecha_indicado";
$result = $db->Execute($sql);

  if (!$result) die("fallo".$db->ErrorMsg());
  while (!$result->EOF) {

 $fecha2=$result->fields["fecha_preparado"];
$fecha=fecha_argentina(strtoupper($result->fields["fecha_preparado"]));
...
?>
    ...
    <td height="50%" colspan="7" bgcolor="#BBCBF7"><div align="center"><a href="consultas.php?fecha2=<?php print("$fecha2");?>"><?php echo $fecha;?></a></div></td>
