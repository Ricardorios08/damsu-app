...
<tr valign="middle" bgcolor="#000099">
    <td height="26" colspan="11"><div align="center" class="Estilo2">
...
<td width="10%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">Receta</span></div></td>
<td width="9%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">TOTAL</span></div></td>
   <td width="5%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">PDF</span></div></td>

      <td width="6%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">FUENTE</span></div></td>
   <td width="6%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">PRESTADOR</span></div></td>
      <td width="6%" bgcolor="#B8B8B8" ><div align="center"><span class="Estilo2">ENVIAR</span></div></td>
   </tr>
...
$sql="select * from tr_ventas_encabezado where fecha = '$fecha' ORDER by nro_factura, fecha desc";
//$sql="select * from tr_ventas_encabezado where fecha between '2019-07-11' and '2019-08-10' and enviar = 'COIR' ORDER by nro_factura, fecha desc";
...
//$sql2 = "UPDATE `tr_ventas_detalle` SET `recibido_coir` = '1'  , fecha_recibido = '$fecha' where nro_factura = $nro_factura";
...
<td><div align="center"><a href="../imprimir_pdf.php?nro_factura=<?php print("$nro_factura");?>" target = "central1"><img src="../../../imagenes/logo_pdf.gif"  alt="PDF" width="32" height="23" longdesc="PDF DESCARGAR"></a></div></td>

<td><div align="center"><span class="Estilo5"><?php print("$nombre_fuente");?></span></div></td>
<td><div align="center"><span class="Estilo5"><?php print("$nombre_prestador");?></span></div></td>
<td><div align="center"><span class="Estilo5"><?php print("$enviar");?></span></div></td>
</tr>
...
$cuenta = "";
   ...
   <tr>
  <td height="21" colspan="11" bgcolor="#B8B8B8"><div align="center" class="Estilo74 Estilo72">
