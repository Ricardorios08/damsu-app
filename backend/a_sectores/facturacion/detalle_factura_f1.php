...
-->
		...
		<form action="estados_f.php" name="f1" method="post" target = "central1">
...
<table width="850">
<tr bgcolor="#6499CB">
  <td colspan="4"><div align="center" class="Estilo1">CONFIRMAR RECEPCION </div></td>
  </tr>
<tr>
...
<tr bgcolor="#B8B8B8">
	<td width="47"><div align="center" class="Estilo4 Estilo5"><strong>CANT</strong></div></td>
	<td width="297"><div align="center" class="Estilo6">DROGA</div></td>
	<td width="219"><div align="center" class="Estilo6">GTIN</div></td>
	<td width="43"><div align="center" class="Estilo6">LOTE</div></td>
	<td width="46"><div align="center" class="Estilo6">VTO</div></td>
	<td width="103"><div align="center" class="Estilo6">RECIBIDA</div></td>
		<td width="103"><div align="center" class="Estilo6">FECHA</div></td>
	</tr>
...
<?php
 ...
 $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  nro_factura = $nro_factura and preparado_coir > 0   order by  cod_detalle desc";
...
$estado= $result3->fields["estado"];
 ...
 $recibido_coir= $result3->fields["indicado_coir"];
...
<?php $di = substr($fecha_farmacia,8,2);$me = substr($fecha_farmacia,5,2);$an = substr($fecha_farmacia,0,4);$fecha_farmacia = $di."/".$me."/".$an;?>


	<?php if ($recibido_farmacia == 1){?>
	<td><div align="center" class="Estilo4"><?php echo $fecha_farmacia;?></div></td>
	<?php }else{?>
