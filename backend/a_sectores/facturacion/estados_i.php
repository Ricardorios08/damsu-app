...
$cont = $cont + 1;
 ...
 echo  $sql1 = "UPDATE `tr_ventas_detalle` SET `indicado_coir` = '$estado_guardar' , `fecha_indicado` = '$hoy_g'  WHERE `cod_detalle` = '$cod_detalle' and `indicado_coir` = 0";
$result1 = $db->Execute($sql1);
 
   $sql1 = "UPDATE `tr_ventas_detalle` SET `indicado_coir` = '$estado_guardar'  WHERE `cod_detalle` = '$cod_detalle' and `preparado_coir` = 0";
$result1 = $db->Execute($sql1);
