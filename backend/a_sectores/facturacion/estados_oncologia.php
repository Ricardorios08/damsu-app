...
$cont = $cont + 1;
    ...
    $sql1 = "UPDATE `tr_ventas_detalle` SET  `fecha_servicio` = '$hoy_g'  WHERE `cod_detalle` = '$cod_detalle' and recibido_servicio = 0";
$result1 = $db->Execute($sql1);

   $sql1 = "UPDATE `tr_ventas_detalle` SET recibido_servicio = '$estado_guardar'  WHERE `cod_detalle` = '$cod_detalle' and aplicado_servicio = 0"; 
$result1 = $db->Execute($sql1);
 ...
 $sql1 = "UPDATE `tr_ventas_detalle` SET `fecha_servicio` = '' WHERE `nro_factura` = '$nro_factura' AND recibido_servicio = 0";
$result1 = $db->Execute($sql1);

$bander = 1;
include ("detalle_factura_oncologia.php");

}ELSE
{
$bander = 1;
$palabra = $documento;
include ("buscar_paciente_general_oncologia.php");
}
?>
