...
<table width="75%" border="0">
  <tr bgcolor="#B8B8B8">
    <td colspan="2" align="center" scope="row"><div align="center"><span class="Estilo13">PREPARAR MERCADERIA </span></div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
LECTOR</span>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="center" scope="row"><div align="left"><span class="Estilo16">
        ...
        <span class="Estilo17"> MANUAL</span></span></div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="center" scope="row">&nbsp;</td>
...
<table width="75%" height="21%" border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#B8B8B8">
    <td height="50%" colspan="6" bgcolor="#F0F0F0"><div align="center" class="Estilo14"><span class="Estilo13">MEDICACION INDICADA </span></div></td>
  </tr>
 <tr>
<?PHP 
...
$fecha_h = $anio."-".$mes."-31";
  ...
  $sql="select * from tr_ventas_detalle where fecha_indicado  between '$fecha_d' and '$fecha_h'  and indicado_coir = 1 group by fecha_indicado order by fecha_indicado";
$result = $db->Execute($sql);

  if (!$result) die("fallo".$db->ErrorMsg());
  while (!$result->EOF) {

 $fecha2=$result->fields["fecha_indicado"];
$fecha=fecha_argentina(strtoupper($result->fields["fecha_indicado"]));
