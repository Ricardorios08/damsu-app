...
include ("../../../conexiones/config_pro.php");
  ...
  $sql="select * from tr_ventas_encabezado where fecha = '$fecha' and enviar = 'COIR'  ORDER by nro_factura, fecha desc";
...
<td><div align="center"><span class="Estilo5"><?php print("$nombre_fuente");?></span></div></td>
 ...
 <tr bgcolor="#FFFFFF">
     <td height="21" colspan="7">&nbsp;<?php include ("detalle_factura_r.php");?></td>
  </tr>
   <tr bgcolor="#FFFFFF">
     <td height="21" colspan="7"><!--DWLayoutEmptyCell-->&nbsp;</td>
   </tr>
