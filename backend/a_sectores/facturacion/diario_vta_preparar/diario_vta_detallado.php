...
<tr bgcolor="#B8B8B8">
	...
	<td width="257"><div align="center" class="Estilo5">GTIN</div></td>
	<td width="62"><div align="center" class="Estilo5">LOTE</div></td>
	<td width="50"><div align="center" class="Estilo5">VTO</div></td>
	<td colspan="2"><div align="center"><span class="Estilo1 Estilo2 Estilo3 Estilo4">CONTROL</span></div></td>
</tr>

<?php

    $sql3 = "SELECT * FROM `tr_ventas_detalle`  WHERE  fecha_indicado = '$fecha' AND indicado_coir = 1 and resultado = '$fuente' order by  fecha_indicado desc";
...
<tr bgcolor="#FFFFFF">
	...
	<td colspan="2"><span class="Estilo5">Paciente: <?php echo $denominacion;?> <BR> <?php echo $nombre_comercial;?></span>	  <div align="center"></div></td>
	<td><span class="Estilo5"><span class="Estilo5">DNI: <?php echo $documento;?></span> <br>
    <?php echo $gtin;?></span></td>
	...
	<td width="29"><div align="center">
	  <input type="checkbox" name="<?php echo control.$cod_detalle;?>" value ="<?php echo $cod_detalle1111;?>" checked id="<?php echo control.$cod_detalle;?>" onClick="ajax1(this);"/>
	</div></td>
	<?PHP
 }else{
?>
<tr bgcolor="#FFFFFF">
	<td><div align="center" class="Estilo5"><?php echo $cantidad;?> </div></td>
	<td colspan="2"><span class="Estilo5">Paciente: <?php echo $denominacion;?> <BR> <?php echo $nombre_comercial;?> </span></td>
	<td><span class="Estilo5">DNI: <?php echo $documento;?></span> <br>
	  <span class="Estilo5"><?php echo $gtin;?></span></span></td>
	<td><div align="center" class="Estilo5"><?php echo $lote1;?></div></td>
	<td><div align="center" class="Estilo5"><?php echo $vto_lote;?></div></td>
	<td width="61"><div align="center">
</div></td>
	<td width="29"><div align="center">
	  <input type="checkbox" name="<?php echo control.$cod_detalle;?>"  value ="<?php echo $cod_detalle;?>" id="<?php echo control.$cod_detalle;?>" onClick="ajax1(this);"/>
	</div></td>
	<?PHP
	}
