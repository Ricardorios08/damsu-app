...
function diferenciaEntreFechas($fecha_principal, $fecha_secundaria, $obtener = 'SEGUNDOS', $redondear = false){
 ...
 $sql1="select * from receta where fecha_factura between '$desde' and '$hasta' and hora_facturacion != '00:00:00' order by fecha_factura, fecha_factura desc";
...
$fecha_0 = $fecha_entrega." ".$hora_ingreso;
...
$horas = substr($tiempo,0,2);
$minutos= substr($tiempo,3,2);
$sum_horas_mon = $sum_horas_mon + $horas;
$sum_minutos_mon = $sum_minutos_mon + $minutos;
//$cant_mon = $cant_mon + 1;
...
?>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
   ...
   <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="11" bgcolor="#330099"><div align="center" class="Estilo87">PROMEDIO X <?php echo $cant;?> DE RECETAS </div>      <div align="center"></div>      <div align="center"></div></td>
  </tr>
   <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
