...
include ("../../funciones/funciones.php");
 ...
 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 1 and tipo_fact = '001' and proveedor = 110";
$result = $db->Execute($sql);
$grupo1=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 2 and tipo_fact = '001' and proveedor = 110";
$result = $db->Execute($sql);
$grupo2=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 3 and tipo_fact = '001' and proveedor = 110";
$result = $db->Execute($sql);
$grupo3=$result->fields["grupo1"];

/////
 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 1 and tipo_fact = '001' and proveedor != 110";
$result = $db->Execute($sql);
$grupo1_noace=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 2 and tipo_fact = '001' and proveedor != 110";
$result = $db->Execute($sql);
$grupo2_noace=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 3 and tipo_fact = '001' and proveedor != 110";
$result = $db->Execute($sql);
$grupo3_noace=$result->fields["grupo1"];





 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 1 and tipo_fact = '002'";
$result = $db->Execute($sql);
$grupo1_u=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 2 and tipo_fact = '002'";
$result = $db->Execute($sql);
$grupo2_u=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from tr_ventas_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 3 and tipo_fact = '002'";
$result = $db->Execute($sql);
$grupo3_u=$result->fields["grupo1"];


 $sql="select sum(total) as grupo1 from compras_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 1";
$result = $db->Execute($sql);
$dev_grupo1=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from compras_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 2";
$result = $db->Execute($sql);
$dev_grupo2=$result->fields["grupo1"];

 $sql="select sum(total) as grupo1 from compras_detalle where  fecha between '$fecha_d' and '$fecha_h' and grupo = 3";
$result = $db->Execute($sql);
$dev_grupo3=$result->fields["grupo1"];

/*
$sql="select sum(precio_unitario * cantidad) as dev_grupo1 from stock where (cod_movimiento =  3  and fecha between '$fecha_d' and '$fecha_h' and grupo = 1) or (cod_movimiento =  2  and fecha between '$fecha_d' and '$fecha_h' and grupo = 1)";
$result = $db->Execute($sql);
$dev_grupo1=$result->fields["dev_grupo1"];

$sql="select sum(precio_unitario * cantidad) as dev_grupo2 from stock where (cod_movimiento =  3  and fecha between '$fecha_d' and '$fecha_h' and grupo = 1) or (cod_movimiento =  2  and fecha between '$fecha_d' and '$fecha_h' and grupo = 2)";
$result = $db->Execute($sql);
$dev_grupo2=$result->fields["dev_grupo2"];

$sql="select sum(precio_unitario * cantidad) as dev_grupo3 from stock where (cod_movimiento =  3  and fecha between '$fecha_d' and '$fecha_h' and grupo = 1) or (cod_movimiento =  2  and fecha between '$fecha_d' and '$fecha_h' and grupo = 3)";
$result = $db->Execute($sql);
...
$grupo1_u = $grupo1_u + $grupo1_noace;
$grupo2_u = $grupo2_u + $grupo2_noace;
$grupo3_u = $grupo3_u + $grupo3_noace;


$unico_1 = $grupo1_u - $dev_grupo1;
$unico_2 = $grupo2_u - $dev_grupo2;
$unico_3 = $grupo3_u - $dev_grupo3;
...
<table width="800" border="0">
  ...
  <tr>
    ...
    <td><div align="right" class="Estilo3"><span class="Estilo1"><?php echo $unico_1;?></span></div></td>
  </tr>
  <tr>
