...
$this->Cell(140,5,'PACIENTE',0,0,'C',true); 
$this->SetX(190);
$this->Cell(20,5,"POP ",0,0,'R',true);  
$this->Cell(20,5,"POP MONO",0,0,'R',true); 
$this->Cell(20,5,"ACE",0,0,'R',true); 
...
$total_grupo1_uni = $total_grupo1;
  $pdf->ln();
  $pdf->SetX(155);
$pdf->Cell(25,5,"RECUPERO DROGAS",0,0,'L'); 
 $pdf->SetX(185);
...
$pdf->Cell(25,5,"TOTAL",0,0,'L'); 
 $pdf->SetX(185);
$pdf->Cell(20,5,number_format($tot1,2),1,0,'R'); 
//$pdf->Cell(20,5,number_format($tot2,2),0,0,'R'); 
$pdf->Cell(20,5,number_format($tot3,2),1,0,'R'); 
$pdf->Cell(20,5,number_format($tot4,2),1,0,'R');  
//$pdf->Cell(20,5,number_format($tot5,2),0,0,'R'); 
$pdf->Cell(20,5,number_format($tot6,2),1,0,'R'); 
$pdf->Cell(20,5,number_format($tot_fin,2),1,0,'R'); 
...
$tot_ingreso_mon = $dev_ace3 + $total_dev3;
