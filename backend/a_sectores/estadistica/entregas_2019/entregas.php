...
$pdf->Cell(140,5,$nombre_completo,0); 
...
$ne_grupo3 = "0";
 ...
 if ($proveedor == 900){
		...
		switch ($grupo){
			...
			case "1":{$compra_directa1  = $total;$total_compra_directa1  = $total_compra_directa1 + $compra_directa1;break;}
			case "2":{$compra_directa12 = $total;$total_compra_directa2 = $total_compra_directa2 + $compra_directa12;break;}
			case "3":{$compra_directa13 = $total;$total_compra_directa3 = $total_compra_directa3 + $compra_directa13;break;}
					}
