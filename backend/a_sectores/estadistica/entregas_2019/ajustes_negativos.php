...
$sql11 = "SELECT * FROM `tr_ventas_encabezado` where fecha between '$desde' and '$hasta' and cod_movimiento = 3 order by nro_factura ";
...
$grupo  = 1;
	...
	if ($proveedor == 110){
		...
		switch ($grupo){
			case "1":{$ne_grupo1 = $total;$total_grupo19999 = $total_grupo1 + $ne_grupo1;$dev_ace1 = $dev_ace1 + $total;break;}
			case "2":{$ne_grupo2 = $total;$total_grupo29999 = $total_grupo2 + $ne_grupo2;$dev_ace2 = $dev_ace2 + $total;break;}
			case "3":{$ne_grupo3 = $total;$total_grupo39999 = $total_grupo3 + $ne_grupo3;$dev_ace3 = $dev_ace3 + $total;break;}
					}
$prov_papo1 = "0";
$prov_papo2 = "0";
$prov_mono = "0";
		...
		switch ($grupo){
			case "1":{$prov_papo1 = $total;$total_prov_papo1 = $total_prov_papo1 - $prov_papo1;$total_prov_papo_grupo1 = $total_prov_papo_grupo1 + $prov_papo;

$prov_papo2 = "0";
$prov_mono = "0";

			break;}
			case "2":{$prov_papo2 = $total;$total_prov_papo2 = $total_prov_papo2 - $prov_papo2;$total_prov_papo_grupo2 = $total_prov_papo_grupo1 + $prov_papo;

$prov_papo1 = "0";
$prov_mono = "0";
break;}
			case "3":{$prov_mono = $total;$total_prov_mono = $total_prov_mono - $prov_mono;
...
if ($prov_papo2 > 0){$prov_papo1 = "-".number_format($prov_papo2,2);}else{$prov_papo2 = "-";}
...
//$pdf->Cell(16,5,number_format($total_renglon,2),0,0,'R'); 
