...
$file="estadisticas.xls";
$test="<table border=1><tr><td>Cell 1</td><td>Cell 2</td></tr></table>";
header("Content-type: application/vnd.ms-excel");
header("Content-Disposition: attachment; filename=$file");

$sql="select sum(precio_unitario) as grupo1 from tr_stock where cod_movimiento =  6  and fecha between '$fecha_d' and '$fecha_h' and grupo = 1";
$result = $db->Execute($sql);
$grupo1=$result->fields["grupo1"];

$sql="select sum(precio_unitario) as grupo2 from tr_stock where cod_movimiento =  6  and fecha between '$fecha_d' and '$fecha_h' and grupo = 2";
$result = $db->Execute($sql);
$grupo2=$result->fields["grupo2"];

$sql="select sum(precio_unitario) as grupo3 from tr_stock where cod_movimiento =  6  and fecha between '$fecha_d' and '$fecha_h' and grupo = 3";
$result = $db->Execute($sql);
