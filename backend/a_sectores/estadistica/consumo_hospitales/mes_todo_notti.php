<?php
$sql = "SELECT *  FROM `tr_ventas_encabezado` WHERE `fecha` between '$desde' and '$hasta' and cod_movimiento != 6  and cod_movimiento != 3 and forma_pago = '$departamento'   ";
$result = $db->Execute($sql);
$recetas = $result->RecordCount(); 

$sql = "SELECT *  FROM `tr_ventas_encabezado` WHERE `fecha` between '$desde' and '$hasta' and  cod_movimiento = 3 and forma_pago = '$departamento'  ";
$result = $db->Execute($sql);
