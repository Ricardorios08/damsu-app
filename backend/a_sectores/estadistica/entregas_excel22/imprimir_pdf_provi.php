...
$this->SetX(150);  
 ...
 $this->Cell(80,6,"$".$this->getNeto(),0,0,'C');
 $this->Ln();
/*
...
$fecha=$result->fields["fecha"];
 ...
 if ($nro_factura == ""){
	 $leyenda = "NO EXISTE ESE COMPROBANTE DE ENTREGA";
...
$pdf->Cell(50,5,$documento11,0); 
$pdf->SetFont('ARIAL','',8);
$pdf->SetX(80);
$pdf->Cell(50,5,"".$nro_ficha11,0); 
$pdf->ln();

$pdf->Cell(15.5,5,"",0); 
$pdf->Cell(50,5,$direccion11,0); 


$pdf->SetFont('ARIAL','B',12);
$pdf->SetX(120);

$pdf->Cell(50,5,$nombre_os11,0); 
$pdf->SetFont('ARIAL','',8);
$pdf->ln();
$pdf->Cell(15.5,5,"",0); 
$pdf->SetFont('ARIAL','B',10);
$pdf->Cell(150,5,$observaciones11,0); 
$pdf->SetFont('ARIAL','',8);
$pdf->ln();
...
$final = $precio_unitario * $cantidad;
