...
<BODY>
<FORM ACTION="buscar_paciente_excel_ca.php" method="post" TARGET = "central1">
<table width="800" border="0">
  <tr bgcolor="#B8B8B8">
    <td colspan="2" align="center" scope="row"><div align="center"><span class="Estilo13">CONSULTA POR DROGA Y TUMOR </span><span class="Estilo17">(versi&oacute;n 2019)</span> </div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td width="376" align="center" bgcolor="#F0F0F0" scope="row"><div align="right" class="Estilo15 Estilo16">Desde</div></td>
    <td width="414" align="center" bgcolor="#FFFFFF" scope="row"><div align="left" class="Estilo17">
      ...
      /
      <input name = "mes" type = "text" id="mes_d" value = "01" maxlength = "2" size = "2">
      / 20
  <input name = "anio" type = "text" id="anio_d" value = "<?php echo $anio;?>" size = "2" maxlength = "2">
    </div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td align="center" bgcolor="#F0F0F0" scope="row"><div align="right" class="Estilo17">Hasta</div></td>
    <td align="center" bgcolor="#FFFFFF" scope="row"><div align="left" class="Estilo17">
      <input name = "dia2" type = "text" id="dia" value = "31" maxlength = "2" size = "2">
      /
      <input name = "mes2" type = "text" id="mes" value = "12" maxlength = "2" size = "2">
      / 20
  <input name = "anio2" type = "text" id="anio" value = "<?php echo $anio;?>" size = "2" maxlength = "2">
    </div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td align="center" bgcolor="#F0F0F0" scope="row"><div align="right" class="Estilo17">Drogas</div></td>
    <td align="center" bgcolor="#FFFFFF" scope="row"><div align="left" class="Estilo17">
      <?php 
include ("../../conexiones/config_usu.php");
  $sql="select * from drogas group by cod_droga ORDER BY droga";
