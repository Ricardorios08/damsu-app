...
$desde = $anio."-".$mes."-01";
$hasta = $anio."-".$mes."-31";
include ("mes_todo_uco.php");
include ("mes1_uco.php");
...
?>
 ...
 <table width="850" border="0" cellspacing="0">
  <tr bgcolor="#CCCCCC">
    <td colspan="5"><div align="center" class="Estilo2 Estilo8">CONSUMO POR PACIENTE PROGRAMA ONCOLOGICO  </div></td>
  </tr>
  <tr bgcolor="#CCCCCC">
    <td colspan="5"><span class="Estilo2 Estilo8">DEPARTAMENTO: <?PHP echo $departamento;?></span><span class="Estilo20"></strong></span></span></td>
  </tr>
  <tr bgcolor="#0000FF">

    <td width="126" bgcolor="#F0F0F0"><div align="center" class="Estilo2 Estilo21"><strong><span class="Estilo5"><span class="Estilo7"><span class="Estilo2"><?PHP echo $anio;?></span></span></span></strong></div></td>
    <td width="148" bgcolor="#F0F0F0"><div align="center" class="Estilo22">CANT. <span class="Estilo2">RECETAS</span></div>    </td>
    <td width="119" bgcolor="#F0F0F0"><div align="center" class="Estilo22">CANT.  PACIENTES</div></td>
    <td width="102" bgcolor="#F0F0F0"><div align="center" class="Estilo21"><strong><span class="Estilo2">COSTO  RECETA</span></strong></div></td>
    <td width="151" bgcolor="#F0F0F0"><div align="center" class="Estilo21"><strong><span class="Estilo2">COSTO PACIENTE </span></strong></div></td>
   </tr>
  <tr>
