...
include ("est_detalle_mono1.php");

  include ("../../../conexiones/config_pro.php");

 $sql="select * from tr_ventas_encabezado where fecha between '$desde' and '$hasta'  and departamento = '$departamento' ORDER by nro_factura, fecha desc";
