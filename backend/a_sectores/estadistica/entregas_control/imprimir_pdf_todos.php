...
$this->SetTextColor(0);
$this->SetFont('');
$titulo = "PROGRAMA ONCOLOGICO - LISTADO DE NOTAS ENTREGADAS - PERIODO NOVIEMBRE 2012 ".$mes." ".$anio;
...
$pdf->Cell(20,5,number_format($total_grupo1_programa,2),0,0,'R');  
$pdf->Cell(20,5,number_format($total_grupo2_programa,2),0,0,'R'); 
$pdf->Cell(20,5,number_format($total_grupo3_programa,2),0,0,'R'); 
$pdf->Cell(20,5,number_format($final,2),0,0,'R'); 
...
$pdf->Cell(50,5,"TIPO",1,0,'C',true);
$pdf->Cell(50,5,"ENTREGADO",1,0,'C',true); 
$pdf->Cell(50,5,"TOTAL PROVISTO",1,0,'C',true); 
$pdf->Cell(50,5,"MONOCLONAL",1,0,'C',true); 
$pdf->ln();
...
$pdf->Cell(50,5,"MONOCLONAL UNICO: ",1,0,'C'); 
...
////////////////////////////////////////////////////
$pdf->Cell(50,5,"G1 ACE: ",1,0,'C'); 
$pdf->Cell(50,5,number_format($total_grupo1,2),1,0,'R'); 
$pdf->Cell(50,5,'',1,0,'R'); 
$pdf->Cell(50,5,'',1,0,'R'); 
   $pdf->ln();

$pdf->Cell(50,5,"G2 ACE: ",1,0,'C'); 
$pdf->Cell(50,5,number_format($total_grupo2,2),1,0,'R'); 
...
$pdf->Cell(50,5,"MONOCLONAL: ",1,0,'C'); 
...
$pdf->ln();
$pdf->Cell(50,5,"TOTAL GASTADO: ",1,0,'C',true); 
$pdf->SetFillColor(224,235,255);
$pdf->SetTextColor(0);
$pdf->SetFont('');

$pdf->Cell(50,5,'',1,0,'R'); 
$pdf->Cell(50,5,number_format($tot_gas,2),1,0,'R'); 
$pdf->Cell(50,5,'',1,0,'R'); 
