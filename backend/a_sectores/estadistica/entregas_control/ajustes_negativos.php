...
$grupo=strtoupper($result9->fields["grupo"]);
	...
	if ($proveedor == 110){
		...
		switch ($grupo){
			case "1":{$ne_grupo1 = $total;$total_grupo1 = $total_grupo1 - $ne_grupo1;$dev_ace1 = $dev_ace1 + $total;break;}
			case "2":{$ne_grupo2 = $total;$total_grupo2 = $total_grupo2 - $ne_grupo2;$dev_ace2 = $dev_ace2 + $total;break;}
			case "3":{$ne_grupo3 = $total;$total_grupo3 = $total_grupo3 - $ne_grupo3;$dev_ace3 = $dev_ace3 + $total;break;}
					}
$prov_papo1 = "0";
$prov_papo2 = "0";
$prov_mono = "0";
...
$pdf->Cell(20,5,number_format($prov_papo1,2),0,0,'R'); 
$pdf->Cell(20,5,number_format($prov_papo2,2),0,0,'R'); 
$pdf->Cell(20,5,number_format($prov_mono,2),0,0,'R'); 
$pdf->Cell(20,5,"-".number_format($ne_grupo1,2),0,0,'R');  
$pdf->Cell(20,5,"-".number_format($ne_grupo2,2),0,0,'R'); 
$pdf->Cell(20,5,"-".number_format($ne_grupo3,2),0,0,'R'); 
