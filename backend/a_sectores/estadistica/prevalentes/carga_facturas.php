...
echo $sql = "SELECT *   FROM `tr_ventas_encabezado` where documento = $documento and fecha between '$desde1' and '$hasta1' group by documento";
...
case "2013":{
echo $sql2 = "UPDATE `cantidad_dptos` SET quimio = 'S' , anio = '$anio_2013' WHERE documento= '$documento'";
$result2 = $db->Execute($sql2);
break;}
