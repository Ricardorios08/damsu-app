...
require_once('../../../drivers/jpgraph/src/jpgraph_pie.php');
require_once ("../../../drivers/jpgraph/src/jpgraph_pie3d.php");
...
$pdf->Cell(0,5,"PACIENTES ATENDIDOS DURANTE EL AÑO POR DEPARTAMENTO",0,0,'C');


$color = "red";	
	$sql1="select * from est_departamento_final";
...
$departamento=strtoupper($result1->fields["departamento"]); // numero
$cantidad=strtoupper($result1->fields["cantidad"]); // numero

$a = $a." array(".$departamento."=>array(".$cantidad.",".$color."),";


$result1->MoveNext();
	}

 $a = $a.",'Grafico',array(20,40,100,50),'grafico')";
