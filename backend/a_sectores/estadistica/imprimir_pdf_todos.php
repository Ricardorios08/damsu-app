...
$tot_dev = $total_dev1 + $total_dev2 + $total_dev3 + $dev_ace1 + $dev_ace2 + $dev_ace3;
 ...
 echo "**".$tot_dev222 = $total_dev1 + $total_dev3 + $dev_ace1 + $dev_ace3;
...
$pdf->Cell(20,5,$tot_dev222,0,0,'R'); 
...
$pdf->SetX(10);
$pdf->Cell(90,5,"TOTAL INGRESOS X RECUPERO DE DROGAS: ",1,0,'C'); 
...
$pdf->SetX(10);
$pdf->Cell(90,5,"TOTAL EGRESOS: ",1,0,'C'); 
