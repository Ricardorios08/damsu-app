...
$hasta= "20".$anio."-".$mes."-31";
 $consulta = "departamento = '$zonas' and fecha between '$desde' and '$hasta' and cod_movimiento = 1 ";
...
$desde1 = $anio."-01-01";
$hasta1 = $anio."-12-31";
	$consulta = "departamento = '$zonas' and fecha between '$desde1' and '$hasta1' and cod_movimiento = 1 ";
 $sql1 = "SELECT * FROM `tr_ventas_encabezado` where $consulta group by documento";
$result1 = $db->Execute($sql1);
