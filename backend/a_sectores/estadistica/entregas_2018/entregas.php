...
$sql5 = "SELECT sum(cantidad) as cantidad,  sum(total) as total FROM `tr_ventas_detalle_entregas`  WHERE  cod_mercaderia = '$cod_mercaderia' and nro_factura = $nro_factura";
...
$ne_grupo1 = $total;
$total_grupo1 = $total_grupo1 + $ne_grupo1;
...
$prov_papo1 = $total;
$total_prov_papo1 = $total_prov_papo1 + $prov_papo1;
	

		/*switch ($grupo){
			case "1":{
$prov_papo1 = $total;$total_prov_papo1 = $total_prov_papo1 + $prov_papo1;
$total_prov_papo_grupo1 = $total_prov_papo_grupo1 + $prov_papo;
break;}
			case "2":{
$prov_papo2 = $total;$total_prov_papo2 = $total_prov_papo2 + $prov_papo2;$total_prov_papo_grupo2 = $total_prov_papo_grupo1 + $prov_papo;
break;}
			case "3":{
$prov_mono = $total;$total_prov_mono = $total_prov_mono + $prov_mono;
break;}
					}*/
...
$pdf->Cell(34,5,$prov_papo1,1,0,'R'); 
//$pdf->Cell(20,5,$prov_papo2,1,0,'R'); 
//$pdf->Cell(20,5,$prov_mono,1,0,'R'); 
$pdf->Cell(33,5,$ne_grupo1,1,0,'R');  
//$pdf->Cell(20,5,$ne_grupo2,1,0,'R'); 
$pdf->Cell(33,5,$ne_grupo3,1,0,'R'); 
