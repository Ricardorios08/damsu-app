...
$this->SetX(0);
$this->ln();
$this->Cell(17,5,'COMPROBANTE',0,0,'C',true); 
$this->Cell(10,5,'FECHA',0,0,'C',true); 
$this->Cell(50,5,'PACIENTE',0,0,'C',true); 
$this->Cell(50,5,'PRESENTACION',0,0,'C',true); 
$this->Cell(50,5,'LABORATORIO',0,0,'C',true); 
$this->SetX(160);
$this->Cell(20,5,"OTROS PROVEEDORES",0,0,'R',true); 
$this->Cell(20,5,"ACE",0,0,'R',true); 
$this->Cell(20,5,"ACE MONOCLONALES",0,0,'R',true); 
