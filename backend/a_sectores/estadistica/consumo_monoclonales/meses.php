...
$sql = "select count(*) as cant from (select distinct documento from `tr_ventas_detalle_depto` where (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3 and cod_movimiento = 1) or (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3 and cod_movimiento = 2) or (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3 and cod_movimiento = 10)) ALIAS";

$result10 = $db->Execute($sql);
$cant_depto_ene=$result10->fields["cant"];

$consulta1 = "(departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3 and cod_movimiento = 1) or (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3 and cod_movimiento = 2) or (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3 and cod_movimiento = 10)";
...
$suma_ene=$result10->fields["suma"];
 ...
 $consulta1 = "(departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3) or (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3) or (departamento = '$zonas' and fecha between '$desde' and '$hasta' and grupo = 3)";
