...
/*
$sql1 = "SELECT * FROM `tr_ventas_detalle_depto` where departamento like '' group by nro_factura";
...
$departamento=$result1->fields["departamento"];
 ...
 $sql = "SELECT * FROM tr_ventas_encabezado where nro_factura = '$nro_factura' and cod_movimiento != 6 ";
...
echo  $sql = "UPDATE `tr_ventas_detalle_depto` SET `departamento` = '$departamento'  WHERE `nro_factura` = '$nro_factura'";
$result = $db->Execute($sql);
...
$sql1 = "SELECT * FROM `tr_ventas_detalle_depto`  group by nro_factura";
 $result1 = $db->Execute($sql1);
...
echo  $sql = "UPDATE `tr_ventas_detalle_depto` SET `cod_movimiento` = '$cod_movimiento'  WHERE `nro_factura` = '$nro_factura'";
$result = $db->Execute($sql);
...
$sql1 = "SELECT * FROM `compras_detalle_depto`  group by nro_factura";
 $result1 = $db->Execute($sql1);
...
$departamento=$result->fields["departamento"];
  ...
  echo $sql = "UPDATE `compras_detalle_depto` SET `departamento` = '$departamento' ,  `cod_diagnostico` = '$cod_diagnostico'   WHERE `nro_factura` = '$nro_factura'";
$result = $db->Execute($sql);
...
<table width="800" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="15" bgcolor="#FFFFFF"><div align="center"><span class="Estilo4">A&Ntilde;O: 20<?php echo $anio;?></span></div></td>
  </tr>
  
  <tr>
    <td colspan="15" bgcolor="#FFFFFF"><div align="left" class="Estilo4">
...
<td bgcolor="#B8B8B8"><div align="center" class="Estilo4 Estilo14"><div align="center"><span class="Estilo2">ENE</span></div></div></td>
<td bgcolor="#B8B8B8"><div align="center" class="Estilo4 Estilo14"><div align="center"><span class="Estilo2">MON</span></div></div></td>
...
<td bgcolor="#B8B8B8"><div align="center"><span class="Estilo13">MON</span></div></td>
   <!-- <td bgcolor="#B8B8B8"><div align="center"><span class="Estilo13">MAY</span></div></td>
	...
	<td bgcolor="#B8B8B8"><div align="center"><span class="Estilo13">MON</span></div></td> -->
    <td bgcolor="#B8B8B8"><div align="center" class="Estilo13">PAC</div></td>
    <td bgcolor="#B8B8B8"><div align="center"><span class="Estilo13">TOT</span></div></td>
  </tr>
...
<?PHP 
 ...
 $sql="select * from tr_ventas_encabezado where departamento != 'CAPITAL' and departamento != '' group by departamento";
$result20 = $db->Execute($sql);

if (!$result20) die("fallo".$db->ErrorMsg());
  while (!$result20->EOF) {
 $zonas=$result20->fields["departamento"];
...
?>
 <tr>
    <td><span class="Estilo4"><?php echo $zonas;?></span></td>
	...
	<td><div align="right"><span class="Estilo10"><?php echo $suma_feb;?></span></div></td>
	...
	<td><div align="right"><span class="Estilo10"><?php echo $suma_abr;?></span></div></td>
    ...
    <td><div align="right"><span class="Estilo10"><?php echo $tot;?></span></div></td>
 </tr>
...
<tr>
   <td>&nbsp;</td>
   <td><div align="center"><span class="Estilo10"><?php echo $tot_ene;?></span></div></td>
   <td><div align="right"><span class="Estilo10"><?php echo $sum_ene;?></span></div></td>
   <td><div align="center"><span class="Estilo10"><?php echo $tot_feb;?></span></div></td>
   <td><div align="right"><span class="Estilo10"><?php echo $sum_feb;?></span></div></td>
   <td><div align="center"><span class="Estilo10"><?php echo $tot_mar;?></span></div></td>
   <td><div align="right"><span class="Estilo10"><?php echo $sum_mar;?></span></div></td>
   <td><div align="center"><span class="Estilo10"><?php echo $tot_abr;?></span></div></td>
   <td><div align="right"><span class="Estilo10"><?php echo $sum_abr;?></span></div></td>
   <td><div align="center"><span class="Estilo10"><?php echo $tot_may;?></span></div></td>
   <td><div align="right"><span class="Estilo10"><?php echo $sum_may;?></span></div></td>
 </tr>
