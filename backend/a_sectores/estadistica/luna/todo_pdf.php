...
$pdf->Cell(0, 5, 'PACIENTES ATENDIDOS EN EL AÑO', 0, 0);
$pdf->Ln();
$valX = $pdf->GetX();
$valY = $pdf->GetY();
$pdf->Ln();
...
$pdf->SetFont('Arial', 'BIU', 12);
$pdf->Cell(0, 5, 'PACIENTES ATENDIDOS POR DEPARTAMENTO EN EL AÑO', 0, 0);
...
$pdf->Ln();
 ...
 // $pdf->SetTextColor(255);
 $sql7="select departamento from `luna_entregas` group by departamento";
...
$tot = $uno + $dos + $tres + $cuatro + $cinco + $seis + $siete + $ocho + $nueve + $diez + $once + $doce;
$total_gral = $total_gral + $tot;
...
$pdf->Cell(10,5,$total_gral,1,0,'C',true);
$pdf->AddPage();
