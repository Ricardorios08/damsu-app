...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bgcolor="#CFCFCF" class="Estilo26">
    <td width="44" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo2 Estilo4">N°</div></td>
    <td width="224" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo3 Estilo2 Estilo4"><span class="Estilo6"><span class="Estilo46">DROGA</span></span></div></td>
    <td width="65" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo6 Estilo2 Estilo4">CANTIDAD</div></td>
    <td width="54" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo5">BORRAR</div></td>
    <td width="44" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo2 Estilo4">N&deg;</div></td>
    <td width="238" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo3 Estilo2 Estilo4"><span class="Estilo6"><span class="Estilo46">DROGA</span></span></div></td>
    <td width="66" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo6 Estilo2 Estilo4">CANTIDAD</div></td>
    <td width="49" bgcolor="#EAEAEA" scope="col"><div align="center" class="Estilo5">BORRAR</div></td>
  </tr>
  <?php 
...
if ($cont == 1){
?><tr bordercolor="#FFFFCC" bgcolor="#E0EDF3"> <?php 
}
