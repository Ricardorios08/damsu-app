...
<?php } else {?>
  ...
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#C4D7E6">
    ...
    <td width="265" bgcolor="#EDEDED" ><font color="#000000" size="2" face="Trebuchet MS">
      <input type="submit" name="Alta" value="CAMBIAR" id = "Alta" />
      <input type="submit" name="Alta" value="BORRAR DETALLE" id = "Alta2" />
    </font></td>
  </tr>
</table>
...
$sql7="delete from receta_detalle_temp where nro_receta = $operador";
