...
?>
  <tr bordercolor="#FFFFCC" bgcolor="#E1F2EF" class="Estilo26">
    <?php 
			...
			?>
    <td height="20" bgcolor="#E6E6E6" class="Estilo61 Estilo82 Estilo85" scope="col"><div align="center"><a href="ver_detalle.php?nro_receta_nuevo=<?php print("$nro_receta_nuevo");?>>&&cod_droga=<?php print("$cod_droga");?>&&documento=<?php print("$documento");?>&&band1=1"><?php print("$cod_droga");?>
    
	</a></span>
</div>
      </div></td>
    <td bgcolor="#E6E6E6" scope="col"><span class="Estilo60 Estilo82 Estilo85"><a href="ver_detalle.php?nro_receta_nuevo=<?php print("$nro_receta_nuevo");?>&&cod_droga=<?php print("$cod_droga");?>&&documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&operador=<?php print("$operador");?>&&band1=1"><?php echo $descripcion;?></a></span></td>
    <td bgcolor="#E6E6E6" scope="col"><div align="center" class="Estilo60 Estilo82 Estilo85"><a href="ver_detalle.php?nro_receta_nuevo=<?php print("$nro_receta_nuevo");?>>&&cod_droga=<?php print("$cod_droga");?>&&documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&operador=<?php print("$operador");?>&&band1=1"><?php echo $presentacion;?></a></div></td>
  </tr>
