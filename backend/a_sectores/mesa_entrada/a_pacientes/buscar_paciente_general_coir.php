...
$result2 = $db->Execute($sql2);
 $sigla=strtoupper($result2->fields["sigla"]);
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="2" bgcolor="#62B0FF"><div align="center"><span class="Estilo1">PROGRAMA ONCOLOGICO </span></div></td>
    <td bgcolor="#FFFFFF"><!--DWLayoutEmptyCell-->&nbsp;</td>
    <td colspan="3" valign="top" bgcolor="#62B0FF"><div align="center" class="Estilo1">COIR</div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
