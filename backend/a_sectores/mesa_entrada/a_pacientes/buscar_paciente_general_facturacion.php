...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bordercolor="#0066FF" bgcolor="#FF0000">
    <td colspan="6" bordercolor="#E6E6E6" bgcolor="#000099"><div align="center"><font color="#FFFFFF" face="Trebuchet MS">aLISTADO DE PACIENTES PROGRAMA ONCOLOGICO NOTAS DE ENTREGA </font></div></td>
  </tr>
  ...
  <tr bordercolor="#0066FF" bgcolor="#FF0000"> 
    ...
    <td width="140" bordercolor="#E6E6E6" bgcolor="#999999"><div align="center"><font color="#000000" face="Trebuchet MS"><font size="2">Nombre </font></font></div></td>
...
?>
 ...
 <?php print("$nombre_completo");?>  
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
	...
	<div id="menuh">
		<ul>
			<li><a href="../a_pacientes/ficha.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>MODIFICAR PACIENTE</a></li>

<li><a href="../a_pacientes/modificar_pacientes.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>HISTORIA CLINICA</a></li>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><table width="366" height="24" border="0" cellspacing="0">
      <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
        <td width="55" bgcolor="#CCCCCC"><div align="center"><font size="2" face="Trebuchet MS">Fecha</font></div></td>
        <td width="185" height="24" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Importe</font></div></td>
		     <td width="188" height="24" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">N&deg; Receta </font></div></td>
             <td width="188" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Ver</font></div></td>
      </tr></table></td>
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><table width="389" border="0" cellspacing="0">
      ...
      <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
        ...
        <td width="60" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Prog.</font></div></td>
        <td width="60" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Unico</font></div></td>
      </tr>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    ...
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><IFRAME src="tabla_receta_facturacion.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&cod_paciente=<?php print("$cod_paciente");?>&&operador=<?php print("$id");?>" width="389" height="200" frameborder="0"> </IFRAME></td>
  </tr>
