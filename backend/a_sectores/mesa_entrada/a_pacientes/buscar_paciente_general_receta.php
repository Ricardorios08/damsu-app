...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bordercolor="#0066FF" bgcolor="#FF0000"> 
    ...
    <td width="138" bordercolor="#E6E6E6" bgcolor="#999999"><div align="center"><font color="#000000" face="Trebuchet MS"><font size="2">Doc.</font></font></div></td>
    <td width="250" bordercolor="#E6E6E6" bgcolor="#999999"><div align="center"><font color="#000000" face="Trebuchet MS"><font size="2">Nombre </font></font></div></td>
...
$sigla=strtoupper($result2->fields["sigla"]);
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
	...
	<div id="menuh">
		<ul>
			<li><a href="../a_pacientes/ficha.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>HISTORIA CLINICA</a></li>
...
<li><a href="../a_pacientes/modificar_pacientes.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>MODIF. PACIENTE</a></li>
			...
			<li><a href="../a_pacientes/entrada_diagnostico.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&cod_paciente=<?php print("$cod_paciente");?>&&band=1" id="primero" target = "central1" >+ DIAGNOSTICO</a></li>
			<li><a href="../../direccion/hc_paciente.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>+ PRESTACIONES</a></li>
			...
			<li><a href="../receta/entrada_receta.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&id=<?php print("$id");?>&&operador=<?php print("$id");?>&&band=1" target = 'central1'>+ RECETAS</a></li>
			<li><a href="../../proveeduria/compras/pagina1.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&id=<?php print("$id");?>&&operador=<?php print("$id");?>&&band=1" target = 'central1'>+ DONACION</a></li>
		</ul>
</div></td>
  </tr>
  <!-- <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><table width="434" height="26" border="0" align="center" cellspacing="0">
      <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
        <td width="54" bgcolor="#CCCCCC"><div align="center"><font size="2" face="Trebuchet MS">Fecha</font></div></td>
        <td width="330" height="24" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Diagnostico</font></div></td>
		     <td width="32" height="24" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Trebuchet MS">Borrar</font></div></td>
      </tr></table></td>
    <td colspan="3" valign="top" bgcolor="#E6E6E6"><table width="317" border="0" align="center" cellspacing="0">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><IFRAME src="../a_pacientes/tabla_diagnostico.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" width="450" height="100" frameborder="0"> </IFRAME></td>
    <td colspan="3" rowspan="2" valign="top" bgcolor="#E6E6E6"><IFRAME src="../a_pacientes/tabla_receta.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&operador=<?php print("$id");?>" width="333" height="200" frameborder="0"> </IFRAME></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><IFRAME src="../a_pacientes/tabla_prestaciones.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" width="450" height="150" frameborder="0"> </IFRAME></td>
  </tr>
...
<tr bgcolor="#FFFF99">
<td colspan="6" bgcolor="#999999"><div align="center"><font face="Trebuchet MS"><a href="entrada_dato.php?documento=<?php print("$palabra");?>" class="Estilo2">INGRESAR NUEVO PACIENTE</a></font></div></td>
 </tr>
<?php }else{?>
  <tr>
    <td colspan="6"></td>
