...
$nombre = "";
	...
	$ok = $_REQUEST['ok'];
$busca2 = $_REQUEST['busca2'];

if (($ok == "ENTREGAS")){
$band = 1;
include ("../../estadistica/entregas/imprimir_pdf.php");
	exit;
}else{
?>
...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bordercolor="#0066FF" bgcolor="#FF0000">
    <td colspan="6" bordercolor="#E6E6E6" bgcolor="#000099"><div align="center"><font color="#FFFFFF" face="Trebuchet MS">aLISTADO DE PACIENTES PROGRAMA ONCOLOGICO </font></div></td>
  </tr>
