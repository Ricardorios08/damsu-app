...
$hasta= "2015-12-31";
 ...
 $sql="select * from  tr_ventas_encabezado where (fecha between '$desde' and '$hasta'  and documento > 5000) group by documento order by cod_diagnostico, departamento, denominacion";
$result = $db->Execute($sql);
