...
<li><a href="../a_pacientes/modificar_pacientes.php?id=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" target = 'central1'>MODIF. PACIENTE</a></li>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><IFRAME src="tabla_diagnostico.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" width="450" height="100" frameborder="0"> </IFRAME></td>
    <td colspan="3" rowspan="2" valign="top" bgcolor="#E6E6E6"><IFRAME src="tabla_receta.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>&&operador=<?php print("$id");?>" width="333" height="200" frameborder="0"> </IFRAME></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#E6E6E6"><IFRAME src="tabla_prestaciones.php?documento=<?php print("$documento");?>&&tipo_doc=<?php print("$tipo_doc");?>" width="450" height="150" frameborder="0"> </IFRAME></td>
  </tr>
