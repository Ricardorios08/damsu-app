...
header("Content-Disposition: attachment; filename=$file");
 ...
 include ("../../../conexiones/config_usu.php");
  ...
  $sql="select * from  paciente_diagnostico where fecha_diagnostico between '2011-01-01' and '2014-12-31' and documento > 500 order by anio desc, cod_diagnostico, fecha_diagnostico";
