...
$hasta= "2015-12-31";
 ...
 $sql="select * from  tr_ventas_encabezado where (fecha between '$desde' and '$hasta' and cod_diagnostico = 'C50' and documento > 5000) OR (fecha between '$desde' and '$hasta' and cod_diagnostico = 'D05' and documento > 5000) group by documento order by departamento, denominacion";
$result = $db->Execute($sql);
