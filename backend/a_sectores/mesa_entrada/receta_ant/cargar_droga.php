...
?>
<BODY onload = "on_load()">
<form action="cargar_droga2.php" method="post">
  <table width="750" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
      <td height="26" colspan="6"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Agregar Droga</font><font size="2" face="Arial, Helvetica, sans-serif"><strong> 
          <input type="text" name="domicilio" id="domicilio" onKeyPress="return verif_caracter(this,event)" size = "10">
          <font size="2" face="Arial, Helvetica, sans-serif"><strong>
          <input type="submit" name="Submit" value="OK">
</strong></font></strong></font></div>        </td>
    </tr>
  </table>
<table width="750" height="22" border="0">
...
<iframe src = "detalle_protocolo.php" width = "750" height = "300" border ="0"> </iframe>
<iframe src = "buscar_droga.php" width = "100" height = "300" border ="0"> </iframe>
</form>
</body>