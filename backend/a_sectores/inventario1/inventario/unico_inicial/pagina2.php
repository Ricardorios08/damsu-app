...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#000099">
    <td height="27" colspan="4" bgcolor="#990000"><div align="center"><font color="#FFFFFF" face="Trebuchet MS">CARGA INVENTARIO UNICO </font></div></td>
...
</font></div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
    <td colspan="5" bgcolor="#E6E6E6"><div align="center"><font size="2" face="Trebuchet MS">Codigo Unico 
        <input type = "text" name = "gtin" id="gtin"  onKeyPress="return verif_caracter(this,event)" tabindex = "2" size = "10">
        Cantidad
        <input type = "text" name = "cantidad" id="cantidad" onKeyPress="return verif_caracter(this,event)"  tabindex = "2" size = "10">
        Unitario
        <input type = "text" name = "precio_unitario" id="precio_unitario"  tabindex = "2" size = "10">
    </font>
