...
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
 ...
 // $sql = "INSERT into tr_stock_contadora_unido SELECT * FROM $tr_stock_provisorio where mes = $mes and anio = $anio and anterior + cantidad - salida > 0 and ace = 1 order by drogas";
mysql_query($sql);
...
$titulo = "INVENTARIO DE MEDICAMENTOS PERIODO: 09/2014";
...
$this->Cell(70,5,'NOMBRE COMERCIAL',1,0,'C'); 
