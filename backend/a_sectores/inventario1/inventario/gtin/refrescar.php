...
$sql = "SELECT * FROM inventario where gtin = '$gtin'";
...
$total = $cantidad * $precio_unitario;
  ...
  $sql = "INSERT INTO inventario ( `gtin` , `fecha` , `cod_operacion` ,`operador` , `cod_mercaderia`  )  VALUES ('$gtin' , '$fecha_guardar' , '', '$usuario' , '$cod_mercaderia')";
mysql_query($sql);
