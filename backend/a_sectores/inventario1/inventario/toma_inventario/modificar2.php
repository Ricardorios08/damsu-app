...
<table width="99%" border="0">
 ...
 <table width="99%" border="0">
  <tr bgcolor="#E8DCFC">
    ...
    <td width="8%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Lote</font></div></td>
    <td width="18%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Mes - A&ntilde;o </font></div></td>
  ...
  <tr bgcolor="#E1F2EF">
    ...
    <td><font color="#000000" size="2"><?php echo $descripcion;?> - <?php echo $presentacion;?>
    ...
    <td><div align="center"><font color="#000000" size="2">
        <input name = "lote" type = "text" id="lote" onKeyPress="return verif_caracter(this,event)" value="<?php echo $lote;?>" size = "10">
    </font></div></td>
    <td><div align="center"><font color="#000000" size="2">
        <input name = "mes_lote" type = "text" id="mes_lote" onKeyPress="return verif_caracter(this,event)" value="<?php echo $mes_lote;?>" size = "2" >
/</font><font color="#000000" size="2">
        20
        <input name = "anio_lote" type = "text" id="anio_lote" onKeyPress="return verif_caracter(this,event)" value="<?php echo $anio_lote;?>" size = "2" maxlength="2" >
</font></div>      </td>
    <td><div align="center">
      <input name = "cantidad" type = "text" id="cantidad"  tabindex = "2" onKeyPress="return verif_caracter(this,event)" value="<?php echo $cantidad_ingresada;?>" size = "2">
    </div></td>
    <td><div align="center">
