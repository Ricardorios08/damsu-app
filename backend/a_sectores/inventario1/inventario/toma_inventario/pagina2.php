...
<table width="800" border="0">
  <tr bgcolor="#000099">
    <td width="33%" height="27"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><font color="#FFFFFF"><strong>DEPOSITO</strong></font> </font> </div></td>
    ...
    <td width="27%" height="27" colspan="2"><div align="right"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><?php echo $fecha1;?></font></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
...
ECHO $cod_mercaderia= $_REQUEST['cod_mercaderia1'];

$anio_actual = date ("y");

if ($anio_lote < $anio_actual){
$leyenda = "SE GUARDO EXISTENCIA CON AÑO VENCIDO";
include ("../../../../alertas/campo_informacion.php");
}

if ($mes_lote > $anio_actual){
...
$sql = "INSERT INTO `existencias` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `lote` ,  `mes_lote` , `anio_lote` , `cantidad_ingresada` , `precio_unitario` , `cantidad_salida` , `fecha_ultimo_mov` )  VALUES ('1' , '' ,'$cod_mercaderia' , '$lote' , '$mes_lote' , '$anio_lote', '$cantidad' , '' , '' , '$fecha_ultimo_mov')";
mysql_query($sql);
 ...
 $sql = "UPDATE `existencias` SET `cantidad_ingresada` = '$cantidad',  `fecha_ultimo_mov` = '$fecha_ultimo_mov' WHERE cod_mercaderia = '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote= '$anio_lote'";
mysql_query($sql);
}

$sql = "INSERT INTO `stock` ( `cod_mercaderia` , `fecha` , `cod_movimiento` , `tipo_fact` , `nro_comprobante` , `cantidad` , `precio_unitario` , `lote` ,  `mes_lote` , `anio_lote` , `cuenta` , `tipo_cuenta` ) VALUES ('$cod_mercaderia' , '$fecha_ultimo_mov' , '1' ,  '0' , '1' , '$cantidad' , '' , '$lote' , '$mes_lote', '$anio_lote' , '0' , '1')";
mysql_query($sql);
...
$cod_merca2=strtoupper($result2->fields["cod_merca"]);

if ($cod_merca2 == ""){
$leyenda = "MERCADERIA EXISTENTE";
include ("../../../../alertas/campo_informacion2.php");
}ELSE{
