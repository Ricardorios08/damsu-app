...
<table width="800" border="0">
  ...
  <tr bgcolor="#FFFFFF">
    <td height="37" colspan="2"><div align="center">PROGRAMA AYUDA PACIENTE ONCOLOGICO</div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td width="62%"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Proveedo GLN</font><font color="#000000"><span class="Estilo9">: </span></font> <span class="Estilo9"><span class="Estilo13"><?php echo $denominacion;?></span></span></div></td>
    <td width="38%"><div align="center"></div>      
    <div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Fecha/Compra: </font><span class="Estilo6"><font color="#000000" size="2"><?php echo $fecha;?></font></span></div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
$nro_factura;
if ($nro_factura != ""){
$sql = "SELECT * FROM `tr_compras1_deta_temp`  WHERE  `nro_factura` = $nro_factura";
}
