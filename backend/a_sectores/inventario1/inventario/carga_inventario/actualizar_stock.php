...
echo $sql = "INSERT INTO `tr_stock` ( `cod_mercaderia` , `fecha` , `cod_movimiento` , `tipo_fact` , `nro_comprobante` , `cantidad` , `precio_unitario` , `lote` ,  `mes_lote` , `anio_lote` , `cuenta` , `tipo_cuenta` ,  `cod_operacion`, `observaciones`, `documento`, `cod_droga`, `nro_os`, `gtin`, `transaccion`, `nro_serie`, `drogas` ) VALUES ('$cod_mercaderia' , '$fecha_ultimo_mov' , '1' ,  'A' , '$nro_factura' , '$cantidad_ingresada' , '$precio_unitario' , '$lote1' , '$mes_lote', '$anio_lote' , '$proveedor' , '1' , '' , '', '' , '$cod_droga' , '' ,  '$gtin' , '$transaccion' , '$nro_serie' , '$drogas')";
mysql_query($sql);
