...
?>
<BODY onload = "on_load()">
<form action="cambiar_existencia_otros.php" method="post">
<table width="800" border="0">
  <!--DWLayoutTable-->
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E6E6E6"> 
    <td height="26" colspan="2" valign="top" bgcolor="#B8B8B8"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif"><strong><font color="#000000">CAMBIAR PRECIO </font> </strong></font>INDIVIDUAL </div></td>
  </tr>
