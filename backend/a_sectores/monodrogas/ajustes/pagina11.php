...
$sql = "INSERT INTO `compras1_encab_temp` ( `nro_factura` , `cod_operacion` , `nro_proveedor` , `denominacion` , `fecha` , `descuento` , `bonificacion` , `periodo` , `anio` , `operador`  , `cod_movimiento` ) VALUES ( '$id' , '$cod_operacion' , '$nro_proveedor' , '$denominacion', '$fecha' , '$porcentaje_dto' , '$porcentaje_boni' , '$periodo' , '$anio1' , '$id' , '$cod_movimiento' )";
mysql_query($sql);
...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#000099">
    <td width="56%" height="27" colspan="4" bgcolor="#CCCCCC"><div align="center"><font color="#000000" face="Trebuchet MS">INGRESO DE MEDICAMENTOS </font></div></td>
    <td width="30%" height="27" colspan="2" bgcolor="#CCCCCC"><div align="right"><font color="#000000" face="Trebuchet MS"><font size="2">Operador:</font> <?php echo $nombre_usuario;?></font></div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
  ...
  <tr bgcolor="#E8DCFC">
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">COD BARRA</font></div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Lote</font></div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Mes - A&ntilde;o </font></div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Pr. Unit</font></div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Cantidad</font></div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Agregar</font></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
    ...
    <td bgcolor="#E6E6E6"><div align="center">
        <input type = "text" name = "cantidad" id="cantidad"  tabindex = "2" size = "2">
    </div></td>
    <td bgcolor="#E6E6E6"><div align="center">
