    ...
    <td width="157" height="371" align="left" valign="top">
	  ...
	  ?>
        ...
        <tr bgcolor="#FFFFCC">
          ...
          <td width="30" height="0"><input type = "text" name = "factura" id="factura" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['factura']))   echo $_REQUEST['factura'];?>"></td>
        </tr>
        <tr bgcolor="#FFFFCC">
          ...
          <td width="30" height="0" bgcolor="#FFFFCC"><input type = "text" name = "porcentaje_boni" id="porcentaje_boni" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['porcentaje_boni']))   echo $_REQUEST['porcentaje_boni'];?>"></td>
        </tr>
        <tr bgcolor="#FFFFCC">
          ...
          <td width="30" height="0"><input type = "text" name = "porcentaje_dto" id="porcentaje_dto" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['porcentaje_dto']))   echo $_REQUEST['porcentaje_dto'];?>"></td>
        </tr>
        </table>      
...
if ($cod_merca == ""){
	?>
              <font color="#FF0000"><?php echo "No existe esa mercaderia ".$cod_merca." ";?></font>
              <?php 
}

else{
?>
              <font color="#006633"><strong><strong><font color="#006633"><strong><strong> <font color="#006633"><strong><strong><strong><?php echo $nombre;?></strong></strong></strong></font></strong></strong></font></strong></strong></font> </font></strong></div></td>
  </tr>
...
?>
	 ...
	 <table width="311" height="30" border="0">
        ...
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
		  ...
		  <a href="imprimir.php?fecha=<?php print("$fecha");?>  && nro_laboratorio=<?php print("$nro_laboratorio");?> && operario=<?php print("$operario");?>&& observaciones=<?php print("$observaciones");?> && nro_recibo=<?php print("$nro_recibo");?>"><font size="-7">IMPRIMIR</font></a>      <div align="left"></div>
          <div align="center"></div>
      <div align="center"></div>
    <div align="center">
      
<a href="carga_merca_stock.php?cod_merca=<?php print("$cod_merca");?>  && precio_unitario=<?php print("$precio_unitario");?> && cantidad=<?php print("$cantidad");?>&& fecha=<?php print("$fecha");?> && factura=<?php print("$factura");?> && cod_grabacion=<?php print("$cod_grabacion");?> && tipo_mov=<?php print("$tipo_mov");?> && condicion=<?php print("$condicion");?>&& nro_proveedor=<?php print("$nro_proveedor");?>&& lote=<?php print("$lote");?>&& vto_lote=<?php print("$vto_lote");?>"><font size="-7">GUARDAR MERCADERIA INGRESADA A LA LISTA DE STOCK</font></a>	  
