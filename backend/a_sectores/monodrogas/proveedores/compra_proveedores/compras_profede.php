      ...
      <div align="left"></div>      <table width="168" border="0">
        ...
        <tr bgcolor="#D0F9FB">
          ...
          <td width="49" height="0">
            <div align="left">
              <input type = "text" name = "nro_proveedor" id="nro_proveedor" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['nro_proveedor']))   echo $_REQUEST['nro_proveedor'];?>">
        ...
        <tr bgcolor="#D0F9FB">
          ...
          <td width="49" height="0"><font color="#000000" size="2">
            <input type = "text" name = "fecha" id="fecha" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['fecha']))   echo $_REQUEST['fecha'];?>">
          </font></td>
        </tr>
        <tr bgcolor="#D0F9FB">
          <td width="106" height="0"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Factura</font></div></td>
          <td width="49" height="0"><input type = "text" name = "factura" id="factura" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['factura']))   echo $_REQUEST['factura'];?>"></td>
        </tr>
        <tr bgcolor="#D0F9FB">
          ...
          <td width="49" height="0"><input type = "text" name = "porcentaje_boni" id="porcentaje_boni" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['porcentaje_boni']))   echo $_REQUEST['porcentaje_boni'];?>"></td>
        </tr>
        <tr bgcolor="#D0F9FB">
          <td width="106" height="0"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">% de Descuento</font></div></td>
          <td width="49" height="0"><input type = "text" name = "porcentaje_dto" id="porcentaje_dto" size = "5" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['porcentaje_dto']))   echo $_REQUEST['porcentaje_dto'];?>"></td>
        </tr>
        </table>      
...
</font></strong></font><strong><font color="#006600"><?php 
...
?> 
<font color="#006633"><strong><strong><font color="#006633"><strong><strong> <font color="#006633"><strong><strong><strong><?php echo $nombre;?></strong></strong></strong></font></strong></strong></font></strong></strong></font> </font></strong><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $presentacion;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong> </p>
</div>              </td>
</tr>
...
?>
         <td height="1"><font size="-1"><?php print $cod_merca;?> </font>
             <div align="left"></div></td>
         <td height="1"><font size="-1"><?php print $nombre;?> </font>
             <div align="left"></div></td>
         <td height="1"><font size="-1"><?php print $cantidad;?> </font>
             <div align="left"></div></td>
         <td height="1"><font size="-1"><?php print $precio_unitario;?> </font>
             <div align="left"></div></td>
         <td height="1"><font size="-1"><?php print $lote;?> </font>
             <div align="left"></div></td>
         <td height="1"><font size="-1"><?php print $vto_lote;?> </font>
             <div align="left"></div></td>
         <?php 
...
$total = ($importe) + ($tipo_iva);
 ...
 ?>
 <td height="1" bgcolor="#B5D0EE"><div align="center"><font size="-7"><font size="-6"><font size="-1"><a href="borra_despues.php?cod_grabacion=<?php print("$cod_grabacion");?>
                   &cod_merca=<?php print("$cod_merca");?>
...
<table width="311" height="30" border="0">
        <tr align="center" bordercolor="#FFFFFF" bgcolor="#006699">
          ...
          <td width="43" height="1" bgcolor="#CCCC99"><div align="center"><font size="-1"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php print $importe;?>
          ...
          <td width="70" bgcolor="#CCCC99"><font size="-7"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633" size="-1"><strong><strong><strong><?php echo $percepcion;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></font></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
          <td height="1" bgcolor="#CCCC99"><font size="-1">IVA</font></td>
          <td width="43" height="1" bgcolor="#CCCC99"><div align="center"><font size="-1"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo$tipo_iva;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></font></div></td>
          <td width="71" height="1" bgcolor="#CCCC99"><div align="center"><font size="-1">TOTAL</font></div></td>
          <td width="70" height="1" bgcolor="#CCCC99"><div align="center"><font size="-1"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $total;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></font></div></td>
        </tr>
		</TABLE>
...
$sql = "INSERT INTO `stockpro` ( `cod_merca1` , `precio_unitario1` , `cantidad1` , `fecha1` , `factura1` , `tipo_mov1` , `condicion1` , `prov_cliente1` , `lote1` , `vto_lote1` ) VALUES ( '$cod_merca', '$precio_unitario' , '$cantidad' , 'fecha', 'factura', 'tipo_mov', 'condicion', 'prov_cliente' , '$lote' , '$vto_lote')";
mysql_query($sql);

$sql = "TRUNCATE FROM detalles_compras where cod_merca = $cod_merca";
mysql_query($sql);

$sql = "TRUNCATE FROM compras_proveeduria where cod_grabacion = $cod_grabacion";
mysql_query($sql);
...
//---------------- Para definir si mantiene el mismo precio o le asigna el anterior -----------------------

$variables1 = array("cantidad1","precio_unitario");
$variables_a_comparar = array("cantidad_stk","precio_unitario_stk");
for($i=0;$i<=sizeof($variables1);$i++){
if($$variables1[$i]==$$variables_a_comparar[$i]){
...
{
 ?>
<font color="#FF0000"><?php echo "No existe esa mercaderia ".$cod_merca." ";?></font><?php 
