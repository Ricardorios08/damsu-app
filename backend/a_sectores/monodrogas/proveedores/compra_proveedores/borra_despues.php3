...
<td height="21"><div align="center"><?php print $nombre;?></div></td>
<td height="21"><div align="center"><?php print $cantidad;?></div></td>
<td height="21"><div align="center"><?php print $precio;?></div></td>


<td bgcolor="#B5D0EE"><div align="center"><a href="borra.php?cod_grabacion=<?php print("$cod_grabacion");?>
                   &cod_merca=<?php print("$cod_merc");?>
				   &cantidad=<?php print("$cantida");?>
				   &precio=<?php print("$preci");?>
				   &cod_grabacion1=<?php print("$cod_grabacion1");?>
">[OK]</a></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
...
?>
        ...
        <tr align="center" bordercolor="#FFFFFF" bgcolor="#006699">
          ...
          <td width="106" bgcolor="#CCCC99"><div align="center"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong>
 <?php 
 ...
 ?>
        ...
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
          <td height="21" colspan="2" bgcolor="#CCCC99">IVA
