...
$sql="select * from proveedores order by cod_proveedor desc";
...
<table width="800" border="0" cellspacing="0">
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#000099"> 
    <td colspan="4" bgcolor="#CCCCCC"><font color="#000000" size="2" face="Trebuchet MS"><strong>CARGA 
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
    ...
    <td bgcolor="#E6E6E6">&nbsp;</td>
    <td colspan="2" bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input type="text" name="domicilio" id="domicilio"  size="45" onKeyPress="return verif_caracter(this,event)">    
      </font></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
    ...
    <td bgcolor="#E6E6E6">&nbsp;</td>
    <td colspan="2" bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input name="cod_area" type="text" id="cod_area" onKeyPress="return verif_caracter(this,event)" value="0261" size="7"> 
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
    ...
    <td bgcolor="#E6E6E6">&nbsp;</td>
    <td colspan="2" bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input name="cod_area_celular" type="text" id="cod_area_celular" onKeyPress="return verif_caracter(this,event)" value="0261" size="7"> 
      <input type="text" name="celular" id="celular" size="15" onKeyPress="return verif_caracter(this,event)">
    </font></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
    ...
    <td bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input type="text" name="servicio" id="servicio"  size="15"onKeyPress="return verif_caracter(this,event)">
    </font></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
    ...
    <td bgcolor="#E6E6E6">&nbsp;</td>
    <td colspan="2" bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input name="denominacion_reducida" type="text" id ="denominacion_reducida" onKeyPress="return verif_caracter(this,event)" size="15" maxlength="10"> 
    </font></tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
    <td bgcolor="#E6E6E6"><div align="right"><font color="#000000" size="2" face="Trebuchet MS">Email</font></div></td>
    <td bgcolor="#E6E6E6">&nbsp;</td>
    <td colspan="2" bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input type="text" name="mail" id="mail" size="45" onKeyPress="return verif_caracter(this,event)">
    </font></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
    ...
    <td bgcolor="#E6E6E6">&nbsp;</td>
    <td colspan="2" bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS">
      <input type="text" name="gln" id="gln" size="45" onKeyPress="return verif_caracter(this,event)">
    </font></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
    <td colspan="4" bgcolor="#CCCCCC"><div align="center">
      <input name="guardar" type="Submit" id="guardar" value="Guardar" target = "arriba">
    </div></td>
    </tr>
</table>
</form>
