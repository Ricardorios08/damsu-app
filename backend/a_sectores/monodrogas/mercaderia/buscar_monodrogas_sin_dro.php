...
ECHO $sql="select * from monodrogas where   grupo = '' order by nombre_comercial asc ";
...
<table width="887" border="1" cellspacing="0">
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="7" valign="top" bgcolor="#D4D0C8"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE MONODROGAS SIN DROGAS CARGADAS . Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
