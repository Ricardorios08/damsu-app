...
$titulo = "ASOC. COOP. HOSPITAL CENTRAL - INVENTARIO DE MEDICAMENTOS UNICO AL ".$hoy;
...
//$pdf->ln();
 ...
 $sql = "SELECT * FROM monodrogas INNER JOIN drogas ON monodrogas.cod_droga=drogas.cod_droga where monodrogas.troquel < 3000 ORDER BY `drogas`.`droga` ASC";
