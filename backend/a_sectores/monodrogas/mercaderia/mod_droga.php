...
$sql="select * from drogas WHERE cod_operacion = $cod_operacion";
...
<BODY onload = "on_load()">
<form action="guardar_mod_droga.php" method="post">
<table width="800" border="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr bordercolor="#FFFFFF" bgcolor="#CCCCCC"> 
    <td height="26" colspan="4"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif"><strong>MODIFICAR 
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6"> 
    ...
    <td colspan="3"><font color="#000000" size="2"><strong><font color="#000000" size="2"> 
      <input type="text" name="droga"  size="45" id="droga"  onKeyPress="return verif_caracter(this,event)" value = "<?php echo $drogas;?>">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td height="24"><div align="right"><font color="#000000" size="2" face="Trebuchet MS">Tratamiento</font></div></td>
    <td colspan="3">
	
	<select name="tratamiento[]" id="tratamiento[]">
	<option value selected= "<?php  print("$cod_droga_nuevo");?>"> <font size="2" face="Trebuchet MS"><strong><font color="#000000"><?php print("$cod_droga_nuevo");?></font></strong></font></option>
