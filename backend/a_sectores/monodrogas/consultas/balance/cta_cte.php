...
<table width="114%" height="58" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#000099">
    <td colspan="14"><div align="right"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong>  BALANCE DE CTA/CTE AL:</strong> <?php echo $hoy;?> </font></div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td colspan="10"><font face="Arial, Helvetica, sans-serif"><strong></strong></font></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#000099">
    ...
    <td width="13%"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">SALDO INCIAL AL: <?php print("$fecha_desde");?></font></div></td>
...
<td width="9%"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">COMP. DE SALDO </font></div></td>
  <td width="4%"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">ERROR</font></div></td>
  </tr>
...
$sql1="select SUM(importe) as creditos from resumen_cta_vta where cuenta like '$palabra' and tipo_cuenta = $tipo and fecha < '$fecha_desde' and (cod_movimiento = 3 or cod_movimiento = 4 or cod_movimiento = 5) ";
$result1 = $db_pro->Execute($sql1);
...
?>
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#E6E6E6">
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?php print("$palabra");?></font></div></td>
    <td><font face="Arial, Helvetica, sans-serif"><strong><font size="1"><?php print("$denominacion");?></font></strong></font></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?php print("$tipo_cuenta");?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($saldo_inicial,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($entrada,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($salida,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($acumula_saldo,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <strong><?php echo number_format($composicion,2);?></strong></font></div></td>
    <td><div align="center"><font size="1"><?php echo $error;?></font></div></td>
  </tr>
...
<?php 
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#E6E6E6">
    ...
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($suma_saldo_inicial,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($suma_entradas,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($suma_salidas,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($suma_saldo,2);?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">$ <?php echo number_format($suma_composicion,2);?></font></div></td>
    <td>&nbsp;</td>
  </tr>
</table>
