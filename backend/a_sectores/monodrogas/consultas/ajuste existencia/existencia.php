...
<table width="113%" height="58" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#E6E6E6">
    <td colspan="12
	"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE EXISTENCIA. Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
...
?>
    <td><div align="center"><font size="2"><?php print("$cod_merca");?></font></div></td>
...
<td><div align="center"><font size="2"><?php print("$lote");?></font></div></td>
<td><div align="center"><font size="2"><?php print("$vto_lote");?></font></div></td>

	<td><div align="center"><font size="2"><?php print("$cantidad_ingresada");?></font></div></td>
	<td><div align="center"><font size="2"><?php print("$cantidad_salida");?></font></div></td>
	<td><div align="center"><font size="2"><?php print("$cantidad_existente");?></font></div></td>
<td><div align="center"><font size="2"><?php print("$estado");?></font></div></td>
<td><div align="center"><font size="2"><?php print("$fecha_ultimo_mov");?></font></div></td>

<td><div align="center"><font size="2"><a href="cambiar_existencia.php?cod_detalle=<?php print("$cod_detalle");?>" onclick="return confirm('¿Está seguro de Modificar existencia de este producto?');"><IMG SRC="../../../../imagenes/office/009.ico" alt="Anular"  border = "0"></a></font></div></td>
