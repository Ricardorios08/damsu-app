...
<table width="103%" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE"> 
      ...
      <?php echo $cod_mercaderia;?>      </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp; </font><font color="#006633" size="2" face="Arial, Helvetica, sans-serif">&nbsp;
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">        <?php  echo $presentacion; ?> </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#D0F9FB"><div align="right">Lote</div></td>
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><?php  echo $lote; ?>
      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#D0F9FB"><div align="right">Vencimiento Lote </div></td>
      <td colspan="2" bgcolor="#E1F2EF"><?php  echo $mes_lote."/".$anio_lote; ?></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#D0F9FB"><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">Cantidad Ingresada </font></div></td>
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
        <input type="text" name="cantidad_ingresada" id="cantidad_ingresada" onKeyPress="return verif_caracter(this,event)" size="2" value = "<?php echo $cantidad_ingresada;?>">
      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#D0F9FB"><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">Cantidad Salida </font></div></td>
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
        <input type="text" name="cantidad_salida" id="cantidad_salida" onKeyPress="return verif_caracter(this,event)" size="2" value = "<?php echo $cantidad_salida;?>">
</font></td>
    </tr>
...
<input type="hidden" name="cod_detalle" value="<?php echo $cod_detalle;?>">
