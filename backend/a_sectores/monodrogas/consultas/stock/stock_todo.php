...
<table width="103%" height="58" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#000099">
    <td colspan="12"><div align="right"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong>FICHA STOCK</strong> <?php echo $hoy;?> </font></div></td>
  </tr>
...
$sql1="select * from monodrogas where troquel = $cod_mercaderia";
...
<tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td colspan="7"><font face="Arial, Helvetica, sans-serif"><strong><font size="2"><?php print("$cod_mercaderia");?> - <?php print("$descripcion");?> (SALDO $<?php echo number_format($saldo1,2);?>) </font></strong></font></td>
  </tr>
<?php }?>
