...
?>
  <tr bordercolor="#FFFFCC" bgcolor="#E1F2EF" class="Estilo26">
    <td height="20" colspan="7" bgcolor="#CFCFCF" class="Estilo61" scope="col"><div align="left"><span class="Estilo80"><span class="Estilo1 Estilo45 Estilo39 Estilo42 Estilo60  Estilo16">Proveedor: </span></span><?php echo $denominacion;?>  </div></td>
  </tr>
  <tr bordercolor="#FFFFCC" bgcolor="#E1F2EF" class="Estilo26">
    <?php 
}
...
?>
<td height="20" class="Estilo61" scope="col"><div align="center"><?php echo $cod_merca;?></span></div></div></td>
    <td scope="col"><span class="Estilo60"><?php echo $descripcion;?></span></td>
    <td scope="col"><div align="center" class="Estilo60"><?php echo $presentacion;?></div></td>
    
      <div align="center" class="Estilo60"></div></td>
    <td scope="col"><div align="center"><span class="Estilo60">$ <?php echo $precio_actualizado;?></span></div></td>
  </tr>
