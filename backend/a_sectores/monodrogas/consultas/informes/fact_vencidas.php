...
<table width="103%" height="86" border="0">
  <!--DWLayoutTable-->
<tr bgcolor="#000099">
    <td height="21" colspan="8" valign="top"><div align="center"><span class="Estilo5"><span class="Estilo1">Listado de FACTURAS VENCIDAS : <?php ECHO $hoy;?></span> </span></div></td>
  </tr>
   <tr bgcolor="#DAFAFC">
...
//$cuenta = "(".$cuenta.") ".$denominacion;
 if ($cuent != $cuenta){?>
   <tr>
     <td height="42" colspan="8" valign="top"><span class="Estilo10"><?php print("$cuenta");?> - <?php print("$denominacion");?></span>       <hr>     </td>
   </tr>
<?php }?>
<tr>
<td><div align="center" class="Estilo4 Estilo5"><span class="Estilo6"><?php print("$tipo_fact");?></span></strong></div></td>
<td><div align="center" class="Estilo4 Estilo7"><span class="Estilo2"><?php print("$nro_factura");?></span></strong></div></td>
<td><div align="left" class="Estilo6"> <div align="center"><strong><?php print("$fecha");?></strong></div></td>
    <!-- <td><div align="center" class="Estilo6"><span class="Estilo4 Estilo5"><?php print("$proveedor");?></span></div></td> -->
<td><div align="center" class="Estilo6">     <?php echo "$ ".number_format($bruto,2);?></div>     </td>
<td><div align="center" class="Estilo6">     <?php echo "$ ".number_format($descuento,2);?></div> </td>
<td><div align="center" class="Estilo6">     <?php echo "$ ".number_format($iva,2);?></div>     </td>
<td><div align="center" class="Estilo8 Estilo6"> <div align="center"><strong><?php echo "$ ".number_format($retencion,2);?></strong></div>
   	</div></td>
<td><div align="center" class="Estilo6"><strong><?php echo "$ ".number_format($total,2);?></strong></div></td>
</tr>
