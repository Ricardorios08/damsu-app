...
?>
  <tr bordercolor="#FFFFCC" bgcolor="#FFFFCC" class="Estilo26">
    <?php 
			...
			?>
    <td height="20" bgcolor="#FFFFCC" class="Estilo61" scope="col"><div align="center"><a href="entrada_factura_2.php?nro_cliente=<?php print("$nro_cliente");?>&&operador=<?php print("$operador");?>&&matricula=<?php print("$matricula");?>&&matricula1=<?php print("$matricula");?>&&nro_factura=<?php print("$nro_factura");?>&&dia=<?php print("$dia");?>&&mes=<?php print("$mes");?>&&anio=<?php print("$anio");?>&&producto=<?php print("$descripcion");?>&&cod_merca=<?php print("$cod_merca");?>&&pasada=1&&no_hacer_nada=<?php print("$no_hacer_nada");?>"><?php print("$cod_merca");?>
    
	</a></span>
	  </div>
    </div></td>
    <td scope="col"><span class="Estilo63"><?php echo $descripcion;?></span></td>
    <td scope="col"><div align="center" class="Estilo63"><?php echo $lote;?>
      </div>
    <div align="center" class="Estilo63"></div></td>
    <td scope="col"><div align="center" class="Estilo63"><?php echo $vto_lote;?>
      </div>
    <div align="center" class="Estilo63"></div></td>
    <td scope="col"><div align="center" class="Estilo63"><?php echo $cantidad_existente;?>
      </div>
    <div align="center" class="Estilo63"></div></td>
  </tr>
