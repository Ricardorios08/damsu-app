...
<table width="113%" height="58" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="10" bgcolor="#E1F2EF"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE EXISTENCIA. Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
...
$sql="select * from monodrogas where troquel like '$cod_mercaderia' ";
...
?>
    ...
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$cod_mercaderia");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="left"><font size="2"><?php print("$descripcion");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$presentacion");?></font></div></td>
<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$lote");?></font></div></td>
<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$cantidad_ingresada");?></font></div></td>
		<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$cantidad_salida");?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$cantidad_existente");?></font></div></td>
<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$fecha_ultimo_mov");?></font></div></td>
