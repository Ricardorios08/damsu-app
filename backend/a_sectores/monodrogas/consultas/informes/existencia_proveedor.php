...
<table width="113%" height="115" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="7" bgcolor="#E1F2EF"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE EXISTENCIA. Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="7" bgcolor="#E1F2EF"><hr noshade></td>
  </tr>
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="7" bgcolor="#E1F2EF"><div align="center"><strong><font face="Arial, Helvetica, sans-serif">PROVEEDOR: <?php print("$cod_proveedor");?> - <?php print("$denominacion");?></font></strong></div></td>
  </tr>
...
<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$saldo");?></font></div></td>
