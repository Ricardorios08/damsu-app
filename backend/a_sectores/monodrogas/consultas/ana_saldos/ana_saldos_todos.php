...
<table width="103%" height="58" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#000099">
    <td colspan="10"><div align="right"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong> DETALLE COMPOSICION DE SALDO </strong> <?php echo $hoy;?> </font></div></td>
  </tr>
...
?>  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td width="30%"><font face="Arial, Helvetica, sans-serif"><strong><font size="2"><?php print("$palabra");?> - <?php print("$denominacion");?> ($ <?php print("$cant");?>)</font></strong></font></td>
...
?>
    ...
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$fecha_emision");?></font></div></td>
...
<tr bgcolor="#C4D7E6">
    <td colspan="6" bgcolor="#000099"><div align="right"><font color="#FFFFFF" size="3"><strong><font face="Arial, Helvetica, sans-serif">TOTAL</font><font color="#FFFFFF" size="3"><strong><font face="Arial, Helvetica, sans-serif"> $ <?php echo number_format($saldo,2);?></font></strong></font></strong></font></div>      <div align="center"></div></td>
    </tr>
</table>
