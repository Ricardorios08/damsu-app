...
$cod_mercaderia = $cod_mercaderia1;
...
else
{
 ...
 echo  $sql = "SELECT * FROM `monodrogas`  WHERE  (`cod_barra` LIKE '$cod_mercaderia%' or troquel LIKE '$cod_mercaderia%' or nombre_comercial  LIKE '$cod_mercaderia%') and `cod_barra` < 1000";
}
...
?>
  ...
  <tr bgcolor="#FFFFFF">
    <td scope="col"><span class="Estilo43"><span class="Estilo37 Estilo39 Estilo40"><a href="pagina2.php?cod_mercaderia=<?php print("$cod_merca");?>&&id=<?php print("$id");?>&&bande_bus=SI"><span class="Estilo39"><?php print("$cod_merca");?>
</span></td>
