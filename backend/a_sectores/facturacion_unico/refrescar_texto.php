...
{
  $sql = "SELECT * FROM drogas where  droga like '$cod_mercaderia%' group by cod_droga order by cod_droga";
}
...
$cod_droga=strtoupper($result->fields["cod_droga"]);
 ...
 $sql1 = "SELECT * FROM existencias where cantidad_ingresada - cantidad_salida > 0 and cod_mercaderia = $cod_droga";
...
$contar = $contar + 1;
    ...
    <td bgcolor="#E6E6E6" scope="col"><div align="center"><span class="Estilo60">$ <?php echo $precio_actualizado;?></span></div></td>
	   <td bgcolor="#E6E6E6" scope="col"><div align="center" class="Estilo60"><?php echo $nro_comprobante;?>
  </tr>
