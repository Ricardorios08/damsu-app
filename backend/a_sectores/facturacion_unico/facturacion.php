...
<li><a href="deterioro/entrada_deterioro.php?id=<?php print("$id");?>" target = "central1" class="Estilo54" >2. INF. DETERIORO </a></li>


<li><a href="facturacion/entrada_factura.php?id=<?php print("$id");?>" target = "central1" class="Estilo54" >2. N/C GTIN </a></li>

<li><a href="facturacion/entrada_factura.php?id=<?php print("$id");?>" target = "central1" class="Estilo54" >1. FACTURA UNICO </a></li>
<li><a href="facturacion/entrada_factura.php?id=<?php print("$id");?>" target = "central1" class="Estilo54" >2. N/C UNICO </a></li>
