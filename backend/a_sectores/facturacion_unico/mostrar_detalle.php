...
<?php include("../../conexiones/config_pro.php");
 $sql6 = "SELECT * FROM `un_ventas1_encab_temp`  WHERE  operador = $operador";
...
<table width="800" border="0">
  <tr bgcolor="#CFCFCF" class="Estilo26">
    <td width="6%" class="Estilo90" scope="col"><div align="center" class="Estilo2 Estilo1 Estilo93">Cant.</div></td>
    ...
    <td width="6%" class="Estilo90" scope="col"><div align="center" class="Estilo6 Estilo2 Estilo1 Estilo93"><span class="Estilo46"> Lote</span></div></td>
		    <td width="8%" class="Estilo90" scope="col"><div align="center" class="Estilo6 Estilo2 Estilo1 Estilo93"><span class="Estilo46">Vto</span></div></td>
            <td width="8%" class="Estilo90" scope="col"><div align="center"><span class="Estilo46 Estilo93">Unit</span></div></td>
...
$precio=strtoupper($result3->fields["precio_unitario"]);
...
?>
  <tr bordercolor="#FFFFCC" bgcolor="#E0EDF3">
    <td class="Estilo90" scope="col"><div align="center" class="Estilo93"><span class="Estilo47 Estilo48"><span class="Estilo26"><?php echo $cantidad;?></span></span></div></td>
    <?php 
...
?>
    ...
    <td height="27" class="Estilo90" scope="col"><div align="left" class="Estilo47 Estilo48 Estilo93"><span class="Estilo26"><?php echo $cod_mercaderia;?> <?php echo $nombre_comercial;?> (<?php echo $cod_mercaderia;?>)</span></div></td>
    <td class="Estilo90" scope="col"><div align="center" class="Estilo46 Estilo93"><span class="Estilo26"><?php echo $lote1;?></span></div></td>
            ...
            <td class="Estilo90" scope="col"><div align="right"><span class="Estilo26"><?php echo $precio;?></span></div></td>
