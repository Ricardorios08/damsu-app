...
$tipo_doc=$result7->fields["tipo_doc"];
  ...
  $sql3="SELECT * FROM `tr_ventas_encabezado` where documento = $documento and tipo_doc = '$tipo_doc'";
...
?>
      ...
      <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
        <td width="107" bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2" face="Trebuchet MS"><a href="../a_pacientes/modificar_des_diagnostico.php?id=<?php print("$documento");?>" target = "central1"><?php print("$tipo_fact");?></a></font><font color="#000000" size="2" face="Trebuchet MS"><a href="../a_pacientes/modificar_des_diagnostico.php?id=<?php print("$documento");?>" target = "central1">-<?php print("$nro_factura");?></a></font></div></td>
...
<a href="../a_pacientes/modificar_des_diagnostico.php?id=<?php print("$documento");?>" target = "central1"><?php print("$fecha");?></a>
        ...
        <td width="43" bgcolor="#E6E6E6"><div align="center"><a href="imprimir_pdf.php?nro_factura=<?php print("$nro_factura");?>" target = "central1"><img src="../../imagenes/logo Pdf.png" width="32" height="23" alt="PDF" longdesc="PDF DESCARGAR"></a></div></td>
     
		<td width="32" bgcolor="#E6E6E6">
		
		<?php if ($nro_fact != ""){?>
		<div align="center"><a href="imprimir_nc_pdf.php?nro_receta=<?php print("$nro_receta");?>" target = "central1"> <img src="../../imagenes/logo Pdf.png" width="32" height="23" alt="PDF" longdesc="PDF DESCARGAR"></a> </div>
		<?php }?>
