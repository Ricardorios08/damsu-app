    ...
    <td width="49%" scope="col"><table width="432" border="0">
      ...
      <tr>
        <td height="21" colspan="3"><div align="left" class="Estilo15"></div>          <div align="left"></div>          
          <span class="Estilo14  Estilo11">IVA</span><span class="Estilo19"><span class="Estilo15  Estilo17">:</span></span><span class="Estilo15  Estilo17"></span><span class="Estilo15 Estilo17"> <?php print("$tipo_fact");?></span></td>
        <td width="90" valign="top" class="Estilo11 Estilo14"><span class="Estilo17"><span class="Estilo16">Cuit: </span></span><strong><span class="Estilo18  Estilo17"><?php echo $cuit;?></span></strong></td>
      </tr>
      <tr>
...
?><tr bgcolor="#FFFFFF">
    <td height="21" scope="col"><span class="Estilo28 Estilo38 Estilo39"><?php echo $cod_mercaderia. " - ".$descripcion;?></span></td>
    <td scope="col"><div align="center" class="Estilo40"><span class="Estilo28"><?php echo $cantidad;?></span></div></td>
