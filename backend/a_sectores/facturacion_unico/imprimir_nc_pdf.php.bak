...
$pdf->SetFont('ARIAL','',8);
 ...
 $sql = "SELECT * FROM `compras_encabezado` where nro_receta = $nro_receta";
...
$pdf->SetX(80);
$pdf->Cell(50,5,"Registro de Tumor: ",0); 
$pdf->ln();

$pdf->Cell(50,5,"Afiliado: ".$documento,0); 
$pdf->SetX(80);
$pdf->Cell(50,5,"Titular: ",0); 
$pdf->ln();
...
$pdf->Cell(50,5,"CANT                                      DETALLE                                                              LOTE                          TOTAL ",0); 
$pdf->ln();
...
$pdf->SetX(20);
$pdf->Cell(50,5,$cod_mercaderia,0); 
$pdf->SetX(60);
