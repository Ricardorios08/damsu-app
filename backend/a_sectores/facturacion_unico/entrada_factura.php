...
<FORM ACTION="entrada_factura_4.php" METHOD = "POST" enctype="multipart/form-data" name="form">
  ...
  <table width="800" border="0" cellspacing="0">
        <tr bgcolor="#000099">
          <td height="35" colspan="2" bgcolor="#CCCCCC"><div align="center" class="Estilo16 Estilo54">ENTREGA DE MEDICAMENTOS UNICO </div></td>
        </tr>
        <tr bgcolor="#E6E6E6">
          <td width="35%" bgcolor="#E6E6E6"><div align="right" class="Estilo55"><span class="Estilo53">OPERADOR</span></div></td>
          <td width="65%" bgcolor="#E6E6E6"><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26"><span class="Estilo53"><span class="Estilo16"><span class="Estilo3"><span class="Estilo4 Estilo6 Estilo55"><span class="Estilo57">
        ...
        <tr bgcolor="#E8DCFC">
          ...
          <td bgcolor="#E6E6E6"><div align="left" class="Estilo55"><span class="Estilo4 Estilo6 "><span class="Estilo21"><span class="Estilo4">
        ...
        <tr bgcolor="#E8DCFC">
          <td bgcolor="#E6E6E6"><div align="right" class="Estilo57">PACIENTE</div></td>
          <td bgcolor="#E6E6E6"><span class="Estilo5">
            <?php echo $nombre_completo;?> (<?php echo $tipo_doc;?>-<?php echo $documento;?>) <input name="primera_vez" type="hidden" value ="1"><input name="cod_paciente" type="hidden" value ="<?php echo $cod_paciente;?>">
			<input name="nro_receta" type="hidden" value ="<?php echo $nro_receta;?>">

          </span></td>
        </tr>
        <tr bgcolor="#E8DCFC">
          <td bgcolor="#E6E6E6"><div align="right"><span class="Estilo57">NOTA</span></div></td>
          <td bgcolor="#E6E6E6"><span class="Estilo4">
            <input name="observaciones" type="text" id="observaciones" onKeyPress="return verif_caracter(this,event)" size = "80" maxlength="100">
          </span></td>
        </tr>
        <tr bgcolor="#FFFFFF">
          <td><div align="right"><span class="Estilo57">ENVIAR A: </span></div></td>
          <td bgcolor="#E6E6E6"> <select name="enviar[]">
             
              <option value="RETIRA POP">RETIRA POP</option>
			   <option value="COIR">COIR</option>
			  <option value=""></option>
            </select></td>
        </tr>
        <tr bgcolor="#E8DCFC">
          <td colspan="2" bgcolor="#CCCCCC"><div align="center"><span class="Estilo55"></span><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26"><span class="Estilo9">
