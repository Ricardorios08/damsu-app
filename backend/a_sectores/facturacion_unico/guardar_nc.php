...
echo  $sql = "INSERT INTO `compras_encabezado` ( `nro_factura` , `cod_operacion` , `nro_proveedor` , `fecha` , `total` , `periodo` , `anio` , `operador` , `tipo_doc` , `documento` , `nro_receta` )  VALUES ( '$nro_factura' , '2' , '900' , '$fecha' , '$total_compra' , '$periodo' , '$anio' ,  '$operador' , '$tipo_doc' ,  '$documento' , '$nro_receta')";
mysql_query($sql);
...
if ($cod_merca == ""){
$cant = $cantidad;
  $sql = "INSERT INTO `existencias` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `lote` ,  `mes_lote` , `anio_lote` , `cantidad_ingresada` , `precio_unitario` , `cantidad_salida` , `fecha_ultimo_mov` , `proveedor` )  VALUES ('$nro_factura' , '' ,'$cod_mercaderia' , '$lote1' , '$mes_lote' , '$anio_lote', '$cant' , '$precio_unitario' , '' , '$fecha_ultimo_mov' ,  '$cuenta')";
mysql_query($sql);


  $sql = "INSERT INTO stock (`cod_mercaderia`, `fecha`, `cod_movimiento`, `tipo_fact`, `nro_comprobante`, `cantidad`, `precio_unitario`, `lote`, `mes_lote`, `anio_lote`, `cuenta`, `tipo_cuenta`, `cod_operacion`, `observaciones`, `tipo_doc`, `documento`, `cod_droga`, `nro_os`) VALUES ('$cod_mercaderia'  , '$fecha_ultimo_mov' , '1' , 'x' , '$documento' , '$cant' , '$precio_unitario' , '$lote1' , '$mes_lote', '$anio_lote' , '900' , '' , '' , '' , '$tipo_doc' ,'$documento' , '$cod_droga' , '$nro_os')";
mysql_query($sql);
...
$cant = $cantidad_ingresada + $cantidad;
 $sql = "UPDATE `existencias` SET `cantidad_ingresada` = '$cant', `precio_unitario` = '$precio_unitario' , `fecha_ultimo_mov` = '$fecha_ultimo_mov' WHERE cod_mercaderia = '$cod_mercaderia' and lote = '$lote1' and mes_lote = '$mes_lote' and anio_lote= '$anio_lote' and cod_detalle = '$cod_deta'";
mysql_query($sql);

$sql = "INSERT INTO stock (`cod_mercaderia`, `fecha`, `cod_movimiento`, `tipo_fact`, `nro_comprobante`, `cantidad`, `precio_unitario`, `lote`, `mes_lote`, `anio_lote`, `cuenta`, `tipo_cuenta`, `cod_operacion`, `observaciones`, `tipo_doc`, `documento`, `cod_droga`, `nro_os`) VALUES ('$cod_mercaderia'  , '$fecha_ultimo_mov' , '1' , 'x' , '$nro_factura' , '$cant' , '$precio_unitario' , '$lote1' , '$mes_lote', '$anio_lote' , '900' , '' , '' , '' , '$tipo_doc' ,'$documento' , '$cod_droga' , '$nro_os')";
mysql_query($sql);
}
...
//mysql_query($sql);
 ...
 $sql = "INSERT INTO `compras_detalle` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `presentacion` , `lote` , `mes_lote` ,  `anio_lote` , `cantidad` , `precio_unitario` , `total` )  VALUES ('$nro_factura' , '' ,'$cod_mercaderia' ,'$presentacion' , '$lote1' , '$mes_lote' , '$anio_lote' , '$cant' , '$precio_unitario' , '$total')";
mysql_query($sql);
...
$sql = "UPDATE compras_encabezado SET `total` = '$total_factura' WHERE `nro_factura` = $nro_factura";
mysql_query($sql);
