...
<?php 
 ...
 $sql1 = "select * from  `tr_stock_temp_provisorio1`  order by cod_mercaderia, mes ";
...
echo " - hay";
 ...
 $sql = "select  sum(cantidad_ingresada - cantidad_salida) as exis from `existencias_31-12-2012` where cod_mercaderia = '$cod_mercaderia'";
