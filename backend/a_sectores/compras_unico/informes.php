...
<table width="154"  border="0">
  ...
  <tr>
    <td bgcolor="#666666"><div align="center" class="Estilo3">MONODROGAS</div></td>
  </tr>
</table>
<div id="menuv">
		<ul>
			<ul>
<li><a href="mercaderia/drogas.php" target = "central1" ><span class="Estilo7">MONODROGAS</span></a></li>
			  <li><a href="mercaderia/entrada_mercaderia.php" target = "central1" ><span class="Estilo7">NOMBRE COMERCIAL</span></a></li>
<li><a href="mercaderia/entrada_laboratorio.php" target = "central1" ><span class="Estilo7"> LABORATORIO</span></a></li>
<li><a href="tasas/entrada_dato.php" target = "central1" ><span class="Estilo7"> TASAS</span></a></li>
<li><a href="actualizacion/actualizar.php" target = "central1" ><span class="Estilo7"> PRECIOS </span></a></li>
    ...
    <tr>
      <td scope="col"><span class="Estilo8">
          <select name="opciones[]" id="busqueda">
            <option value="mod_drg">DROGAS</option>
            <option value="mod_mer">MONODROGAS</option>
            <option value="mod_lab">LABORATORIOS</option>
