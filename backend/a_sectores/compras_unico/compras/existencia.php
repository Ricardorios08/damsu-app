...
<table width="103%" height="58" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="12
	" bgcolor="#E1F2EF"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE MERCADERIA Y PRECIOS CON EL PLAN: </font><strong><font size="4" face="Arial, Helvetica, sans-serif"><?php print("$plan");?></font></strong><font size="4" face="Arial, Helvetica, sans-serif">.</font>  <font color="#000000" face="Arial, Helvetica, sans-serif">Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
...
?>
  <tr bordercolor="#FFFFCC" bgcolor="#FFFFCC">
    <?php 
		...
		?>
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?php print("$cod_merca");?></font></div></td>
	...
	<td bgcolor="#E8DCFC"><div align="center"><font size="2">$ <?php print("$precio_actualizado");?></font></div></td>
