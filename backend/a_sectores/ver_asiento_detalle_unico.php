...
include ("../conexiones/config_pro.php");
 ...
 echo $sql1 = "select * from `stock` where cod_movimiento = 6 order by nro_comprobante";
...
$nro_comprobante=$result1->fields["nro_comprobante"];
 ...
 $sql18 = "select * from `tr_ventas_detalle` where cod_mercaderia = '$cod_mercaderia' and nro_factura = $nro_comprobante ";
