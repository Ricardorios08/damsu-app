...
$sql1="select * from tr_existencias where cantidad_ingresada - cantidad_salida > 0";
...
if ($cont == ""){
$sql = "('$nro_factura', '$cod_detalle', '$cod_mercaderia', '$lote', '$mes_lote', '$anio_lote', '$cantidad_ingresada', '$precio_unitario', '$cantidad_salida', '$fecha_ultimo_mov', '$proveedor', '$gtin', '$transaccion', '$nro_serie', '$cod_droga', '$grupo', '$laboratorio')";
$cont = $cont + 1;
$sql1 = $sql;
}else{
	$cont = $cont + 1;
...
$sql1 = $sql1.";";
 ...
 $sql8 = "INSERT INTO `tr_existencias` (`nro_factura`, `cod_detalle`, `cod_mercaderia`, `lote`, `mes_lote`, `anio_lote`, `cantidad_ingresada`, `precio_unitario`, `cantidad_salida`, `fecha_ultimo_mov`, `proveedor`, `gtin`, `transaccion`, `nro_serie`, `cod_droga`, `grupo`, `laboratorio`) VALUES ".$sql1;
...
$sql1 = $sql1.";";
 ...
 $sql9 = "INSERT INTO `tr_ventas_encabezado` (`tipo_fact`, `nro_factura`, `nro_receta`, `documento`, `tipo_doc`, `plan`, `operador`, `denominacion`, `fecha`, `forma_pago`, `porc_dto`, `nombre_operador`, `nro_os`, `nombre_os` , `neto` , `cod_movimiento` , `tipo_factura` , `observacionnes` , `departamento`) VALUES ".$sql1;
