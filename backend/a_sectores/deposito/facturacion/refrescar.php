...
?><table width="103%" border="0">
  <tr bgcolor="#FFBC79">
    <td width="31%" scope="col"><div align="center" class="Estilo26">Descripcion / Mercaderia</div></td>
	    <td width="14%" scope="col"><div align="center" class="Estilo26">Presentacion</div></td>
    <td width="20%" scope="col"><div align="center" class="Estilo28">Cantidad</div></td>
    ...
    <td width="8%" scope="col"><div align="center" class="Estilo28"> C/U</div></td>
    <td width="7%" scope="col"><div align="center" class="Estilo28">Total</div></td>
    <td width="4%" class="Estilo28" scope="col"><div align="center">Borrar</div></td>
  </tr><?
...
?><tr bgcolor="#FFFFFF">
    <td height="34" scope="col"><span class="Estilo28"><?echo $cod_mercaderia. " - ".$descripcion;?></span></td>
   ...
   <td width="4%" class="Estilo6"><div align="center"><a href="borrar_item.php?cod_detalle=<?print("$cod_detalle");?>&&nro_factura=<?print("$nro_factura");?>&&nro_cliente=<?print("$nro_cliente");?>&&matriculae=<?print("$matricula");?>&&forma_pago=<?print("$forma_pago");?>&&dia=<?print("$dia");?>&&mes=<?print("$mes");?>&&anio=<?print("$año");?>&&mes=<?print("$mes");?>&&band=<?print("$band");?>"><IMG SRC="../../../imagenes/botones/btn_anular.gif" alt="Anular" border = "0"></a></div></td>
  </tr>
<?
