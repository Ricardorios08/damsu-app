...
<table width="252" border="0">
  <tr bgcolor="#E8DCFC">
    <th width="70" scope="col"> 
      <div align="center">
        <input name="cod_mercaderia" type="text" id="cod_mercaderia" size = "10" onKeyPress="return verif_caracter(this,event)"> 
        </div></th>
    <td width="172" rowspan="2" scope="col"><div align="center">Ingrese el nombre o n&uacute;mero de producto a buscar</div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
    <th scope="col"><font color="#000099">
      <input type="Submit" name="Alta" value="OK">
    </font></th>
  </tr>
  <tr bgcolor="#000099">
    <td scope="col"><div align="center" class="Estilo1">Cod.</div></td>
...
?>
  ...
  <tr bgcolor="#FFFFFF">
    <td scope="col"><span class="Estilo2"><?echo $cod_merca;?></span></td>
    <td scope="col"><span class="Estilo2"><?echo $descripcion;?></span></td>
  </tr>
