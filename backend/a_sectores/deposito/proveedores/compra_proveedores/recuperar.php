...
?>
 <a href="imprimir.php?cod_grabacion=<?php print("$cod_grabacion");?>  && cod_merca=<?php print("$cod_merca");?> && presentacion=<?php print("$presentacion");?>&& lote=<?php print("$lote");?> && vto_lote=<?php print("$vto_lote");?>&& cantidad=<?php print("$cantidad");?>&& precio=<?php print("$precio");?>">IMPRIMIR</a> </div>
