          ...
          <tr bgcolor="#E0EDF3">
            ...
            <td width="203" colspan="2" bgcolor="#E0EDF3">
              <div align="left">
                ...
                <input type = "text" name = "cod_merca" id="cod_merca" size = "4" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['cod_merca']))   echo $_REQUEST['nombre'];?>">
                <?php 
...
?>
      ...
      <input type = "text" name = "presentacion" id="presentacion" size = "10" onKeyPress="return verif_caracter(this,event)" value="<?php php if (isset($_REQUEST['presentacion'])) echo $_REQUEST['presentacion'];?>">
      </font>
      <tr bgcolor="#E0EDF3">
      ...
      <td height="26" valign="top"><font color="#000000" size="2">
      <input type = "text" name = "lote" id="lote" size = "10" onKeyPress="return verif_caracter(this,event)" value="<?php php if (isset($_REQUEST['lote'])) echo $_REQUEST['lote'];?>">
      </font>
      <tr bgcolor="#E0EDF3">
      <td height="26" valign="top" bgcolor="#E0EDF3"><div align="right"><font color="#000000">Vencimiento del lote</font>                    
      </div>
      <td height="26" valign="top"><font color="#000000" size="2">
      <input type = "text" name = "vto_lote" id="vto_lote" size = "10" onKeyPress="return verif_caracter(this,event)" value="<?php php if (isset($_REQUEST['vto_lote'])) echo $_REQUEST['vto_lote'];?>">
      </font>                    
      ...
      <td height="26" valign="top"><font color="#000000" size="2">
      <input type = "text" name = "precio_unitario" id="precio_unitario" size = "10" onKeyPress="return verif_caracter(this,event)" value="<?php php if (isset($_REQUEST['precio_unitario'])) echo $_REQUEST['precio_unitario'];?>">
      </font>
    ...
    <div align="center">
      <table width="227" height="163" border="0">
        ...
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
          <td bgcolor="#FFFFCC"><?php echo $cod_merca;?></td>
          <td bgcolor="#FFFFCC"><?php print $nombre;?></td>
          <td bgcolor="#FFFFCC"><div align="center">
		  <a href="borra.php?
		             &cod_merca=<?php print("$cod_merca");?>
	   	             &nombre=<?php print("$nombre");?>
		                                                  ">[OK]</a></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#006699">
          ...
          <td bgcolor="#CCCC99"><div align="center"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $neto_grabado;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
      ...
      <div align="right"><a href="imprimir.php?fecha=<?php print("$fecha");?>  && nro_laboratorio=<?php print("$nro_laboratorio");?> && operario=<?php print("$operario");?>&& observaciones=<?php print("$observaciones");?> && nro_recibo=<?php print("$nro_recibo");?>">IMPRIMIR</a> </div>
    </div></td>
  </tr>
</table>
<div align="right"></div>
