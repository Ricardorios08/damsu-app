...
<table width="714" border="0">
      <tr bgcolor="#FFFFFF">
        <td width="399"><div align="center">
          <p align="left"><?php echo "Fecha: ".$fecha;?><BR>
        </div></td>
        <td width="305" colspan="2"><div align="right">Planilla de Ventas  Nº: <?php echo " ".$factura;?></div></td>
      </tr>
      <tr>
        <td colspan="3"><hr></td>
      </tr>
  ...
  <tr bgcolor="#FFFFFF">
    <td colspan="3"><hr>      <em>Proveedor: <font color="#0000CC"><?php echo " ".$denominacion." (".$nro_proveedor.")";?></font></em></td>
  </tr>
...
<div align="left">
  ...
  <table width="713" border="0">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td colspan="6"><div align="center"><strong><?php echo "     "?>CANTIDAD</strong></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="23" colspan="2"><div align="center"></div>        <div align="center"><strong><?php echo "     ".$cod_merca;?></strong></div></td>
      <td width="134">&nbsp;</td>
      <td width="68">&nbsp;</td>
      <td width="101">&nbsp;</td>
      <td width="101"><strong><?php echo "     ".$cantidad;?></strong></td>
    ...
    <tr bordercolor="#000000" bgcolor="#FFFFFF">
	  ...
	  <td height="28" colspan="7"><div align="right"><strong>TOTAL DE LA COMPRA:<span class="Estilo1">..........</span><?php echo "     ".$cantidad;?></strong></div>
