...
<!-- <FORM ACTION="guardar_vtas_pro.php"<?php php echo $_SERVER["PHP_SELF"];?>" METHOD = "POST">-->
<!--  <form action="guardar_vtas_pro.php" method="post">-->

<FORM name="form" ACTION="<?php php echo $_SERVER["PHP_SELF"];?>" METHOD = "POST">
<table width="590" border="1" bordercolor="#FFFFFF">
  <!--DWLayoutTable-->
  ...
  <tr>
    <td width="398" height="401" align="left" valign="top"><div align="center">
        <table width="278" border="0">
          ...
          <tr bgcolor="#FFFFCC">
            ...
            <td width="84" bgcolor="#FFFFCC">
              <div align="left">
                <input type = "text" name = "nro_proveedor" id="nro_proveedor" size = "8" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['nro_proveedor']))   echo $_REQUEST['nro_proveedor'];?>">
	  ...
	  ?>
          ...
          <tr bgcolor="#FFFFCC">
            ...
            <td><font color="#000000" size="2">
              <input type = "text" name = "fecha" id="fecha" size = "8" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['fecha']))   echo $_REQUEST['fecha'];?>">
            </font></td>
          </tr>
          <tr bgcolor="#FFFFCC">
            <td height="25" bgcolor="#FFFF99"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Factura</font></div></td>
            <td><input type = "text" name = "factura" id="factura" size = "8" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['factura']))   echo $_REQUEST['factura'];?>"></td>
          </tr>
          <tr bgcolor="#FFFFCC">
            ...
            <td bgcolor="#FFFFCC"><input type = "text" name = "porcentaje_boni" id="porcentaje_boni" size = "8" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['porcentaje_boni']))   echo $_REQUEST['porcentaje_boni'];?>"></td>
          </tr>
          <tr bgcolor="#FFFFCC">
            ...
            <td><input type = "text" name = "porcentaje_dto" id="porcentaje_dto" size = "8" onKeyPress="return verif_caracter(this,event)" maxlength="5"  value="<?php php if (isset($_REQUEST['porcentaje_dto']))   echo $_REQUEST['porcentaje_dto'];?>"></td>
          </tr>
        </table>
        <div align="center"><br>
        </div>
...
?>
                <font color="#006633"><strong><strong><font color="#006633"><strong><strong> <font color="#006633"><strong><strong><strong><?php echo $nombre." (".$cod_merca.")";?></strong></strong></strong></font></strong></strong></font></strong></strong></font> </font></strong></div></td>
</tr>
    ...
    <td width="253" valign="top">
	 ...
	 <table width="258" border="0">
        <tr align="center" bordercolor="#FFFFFF" bgcolor="#006699">
          ...
          <th width="129" scope="col"><div align="center"><font color="#FFFFFF">Practica</font></div></th>
          <th width="70" scope="col"><div align="center"><font color="#FFFFFF">Eliminar</font></div></th>
        </tr>
        <?php 
...
$cod_grabacion=$cod_merca.$lote.$vto_lote.$factura;
...
$sql = "INSERT INTO `detalles` ( `cod_grabacion` , `cod_merca` , `presentacion` , `lote` , `vto_lote` , `cantidad` , `precio` )VALUES ( '$cod_grabacion' , '$cod_merca' , '$presentacion' , '$lote' , '$vto_lote', '$cantida' ,'$precio')";
mysql_query($sql);
...
$sql9="select * from detalles where cod_grabacion = '$cod_grabacion'";
...
?>
<td height="21"><div align="center"><?php print $cod_merca;?></div></td>
<td><div align="left"> <?php echo $nombre;?></div></td>
<td bgcolor="#FFFFFF"><div align="center"><a href="borra.php?cod_grabacion=<?php print("$cod_grabacion");?>
                   &cod_merca=<?php print("$cod_merc");?>
">[OK]</a></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
...
?>
		  ...
		  <table width="258" height="94" border="0">
        <tr align="center" bordercolor="#FFFFFF" bgcolor="#006699">
		  <td height="21" colspan="2" bgcolor="#CCCC99"><div align="center"></div>
              <div align="left">NETO GRABADO </div></td>
          <td width="59" bgcolor="#CCCC99"><div align="center"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $neto_grabado;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
          <td height="21" colspan="2" bgcolor="#CCCC99">IVA</td>
          <td bgcolor="#CCCC99"><div align="center"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $iva;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
          <td height="21" colspan="2" bgcolor="#CCCC99">PERCEPCION</td>
          <td bgcolor="#CCCC99"><div align="center"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $percepcion;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></div></td>
        </tr>
        <tr bordercolor="#B5D0EE" bgcolor="#B5D0EE">
          <td height="21" colspan="2" bgcolor="#CCCC99">TOTAL</td>
          <td bgcolor="#CCCC99"><div align="center"><strong><font color="#006600"><font color="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#006633"><strong><strong><strong><?php echo $total;?></strong></strong></strong></font></strong></strong></font></strong></strong></font></font></strong></div></td>
        </tr>
</table> 
...
<table width="538" height="432" border="0" bordercolor="#FFFFFF">
  <a href="imprimir.php?fecha=<?php print("$fecha");?>  && nro_laboratorio=<?php print("$nro_laboratorio");?> && operario=<?php print("$operario");?>&& observaciones=<?php print("$observaciones");?> && nro_recibo=<?php print("$nro_recibo");?>">IMPRIMIR</a><tr bordercolor="#333333" bgcolor="#993300">
