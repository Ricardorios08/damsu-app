...
<table width="103%" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE"> 
      ...
      <input type="text" name="cuenta" id="cuenta" value = "<?php echo $a;?>" onKeyPress="return verif_caracter(this,event)" size="5" > 
...
Baja </font><font color="#006633" size="2" face="Arial, Helvetica, sans-serif">&nbsp;
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
      ...
      <input name="denominacion" type="text" id="denominacion" onKeyPress="return verif_caracter(this,event)" value="<?php echo $denominacion;?>"  size="25">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
      ...
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="domicilio" type="text"  id="domicilio" onKeyPress="return verif_caracter(this,event)" value="<?php echo $domicilio;?>"  size="25">                
      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Puerta</font></div></td>
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="puerta" type="text" id="puerta"onKeyPress="return verif_caracter(this,event)" value="<?php echo $puerta;?>"  size="3">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
      ...
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="referencia" type="text" id="referencia"onKeyPress="return verif_caracter(this,event)" value="<?php echo $referencia;?>"  size="35">
      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
    ...
    <tr bordercolor="#FFFFFF"> 
      ...
      <td colspan="2" bgcolor="#E1F2EF"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif">
		...
		<optgroup label="Opcion Seleccionada">
			<option value selected= "<?php "$localidad";?>"> <?php print("$localidad");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
      ...
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="caracteristica_1" type="text" id="caracteristica_1" onKeyPress="return verif_caracter(this,event)" value="<?php echo $caracteristica_1;?>" size="7">
      <input name="telefono_1" type="text" id="telefono_1" onKeyPress="return verif_caracter(this,event)" value="<?php echo $telefono_1;?>" size="10"> 
      (Fijo)                </font></td>
    </tr>
    <tr bordercolor="#FFFFFF"> 
      <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Telefono(2)</font></div></td>
      <td colspan="2" bgcolor="#E1F2EF">        <font size="2" face="Arial, Helvetica, sans-serif">
      <input name="caracteristica_2" type="text" id="caracteristica_2" onKeyPress="return verif_caracter(this,event)" value="<?php echo $caracteristica_2;?>" size="7">       
      <input name="telefono_2" type="text" id="telefono_2" onKeyPress="return verif_caracter(this,event)" value="<?php echo $telefono_2;?>" size="10">
(Fijo)  </font>        <div align="right"></div>                  </td>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="caracteristica_3" type="text" id="caracteristica_3" onKeyPress="return verif_caracter(this,event)" value="<?php echo $caracteristica_3;?>" size="7">   
      <input name="telefono_3" type="text" id="telefono_3" onKeyPress="return verif_caracter(this,event)" value="<?php echo $telefono_3;?>" size="12">
      (Celular)
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td colspan="2" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="email" type="text" id="email" onKeyPress="return verif_caracter(this,event)" value="<?php echo $email;?>" size="55">
      </font>
        <div align="right"></div>
      <div align="left"> </div></td>
    </tr>
...
<table width="103%" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
        <input name="cuit" type="text" id="cuit" onKeyPress="return verif_caracter(this,event)" value="<?php echo $cuit;?>" size ="15">
      </strong></font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td width="72%" colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
		...
		<optgroup label="Opcion Seleccionada">
			<option value selected= "<?php "$iva";?>"> <?php print("$iva");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
    ...
    <tr bordercolor="#FFFFFF">
      <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Ingresos Brutos </font></div></td>
      <td colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
      <select name="ingresos_brutos[]" id="ingresos_brutos" onkeypress="return verif_caracter(this,event)">
		<optgroup label="Opcion Seleccionada">        
			<option value selected= "<?php "$ingresos_brutos";?>"> <?php print("$ingresos_brutos");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
    ...
    <tr bordercolor="#FFFFFF">
      <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Condiciones</font></div></td>
      <td colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
        <select name="condiciones[]" id="condiciones" onkeypress="return verif_caracter(this,event)">
		<optgroup label="Opcion Seleccionada">
	<option value selected= "<?php "$condiciones";?>"> <?php print("$condiciones");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
          <option value = "Normal">Normal</option>
          <option value = "Con Descuento">Con Descuento</option>
          <option value = "Con Recargo">Con Recargo</option>
		  </optgroup>
        </select>
      </strong>(sobre la venta)      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Credito $ </font></div></td>
      <td colspan="3" bgcolor="#E1F2EF"> <font size="2" face="Arial, Helvetica, sans-serif"><strong>
        <input name="credito" type="text" id="credito" onKeyPress="return verif_caracter(this,event)" value="<?php echo $credito;?>" size = "8">
        </strong>(
M&aacute;ximo credito importe en pesos) </font>        <div align="right"></div></td>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#eeeeee">
      ...
      <td colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
		...
		<optgroup label="Opcion Seleccionada">
	<option value selected= "<?php "$flete";?>"> <?php print("$flete");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#eeeeee">
      ...
      <td colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
        <input name="observaciones" type="text" id="observaciones" onKeyPress="return verif_caracter(this,event)" value="<?php echo $observaciones;?>" size = "55">
      </strong></font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#eeeeee">
      <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Plan</font></div></td>
      <td colspan="3" bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif"><strong>
        <input name="plan" type="text" id="observaciones3" onKeyPress="return verif_caracter(this,event)" value="<?php echo $plan;?>" size = "2">
      </strong></font></td>
    </tr>
