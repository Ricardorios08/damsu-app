...
<table width="996" border="1">
  <tr bgcolor="#FFBC79">
    ...
    <td width="325" scope="col"><div align="center" class="Estilo28 Estilo1 Estilo2">MEDICAMENTO</div></td>
...
?><tr bgcolor="#FFFFBF">
    ...
    <td bgcolor="#FFFFBF" scope="col"><div align="center"><span class="Estilo28 Estilo1 Estilo2"><?php echo $nombre_comercial;?></span></div></td>
...
<table width="996" border="1">
    ...
    <td width="300" height="29" scope="col"><div align="center" class="Estilo35 Estilo36 Estilo1 Estilo2">
      <div align="right">Neto Grabado $ <?php echo number_format($neto,2);?></div>
    </div>      </td>
    <td scope="col"><div align="right" class="Estilo3">
      <div align="right"><span class="Estilo37">IVA </span>$ <?php echo number_format($iva,2);?>
      </div>
    </div>
      <div align="right"><span class="Estilo1"><span class="Estilo2"></span></span></div></td>
    <td scope="col"><div align="right" class="Estilo3 Estilo4"><strong>TOTAL $ <?php echo number_format($total_factura,2);?></strong></div>      </td>
  </tr>
<?php 
$cod_barra == "";
?></table>
