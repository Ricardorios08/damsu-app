...
<table width="800" border="0">
  ...
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td width="19%" height="24" bgcolor="#EDEDED"> <div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">GTIN MAL CARGADO</font>:</div></td>
    <td width="81%" bgcolor="#EDEDED"><div align="left"> <font color="#000000" size="2"><strong><font color="#000000" size="2"> 
        <input type="text" name="mes"  size="80" id="mes" onKeyPress="return verif_caracter(this,event)">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td height="24" bgcolor="#EDEDED"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">GTIN CORRECTO </font></td>
    <td bgcolor="#EDEDED"><font color="#000000" size="2"><strong><font color="#000000" size="2"><strong><font color="#000000" size="2">
      <input name="anio" type="text" id="anio" onKeyPress="return verif_caracter(this,event)"  size="80">
