...
?>
<BODY onload = "on_load()">
<form action="arreglar_prov.php" method="post">
<table width="800" border="0">
  ...
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td width="26%" height="24" bgcolor="#EDEDED"> <div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">GTIN CON PROVEEDOR ERRONEO </font></div></td>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td height="24" bgcolor="#EDEDED"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">PROVEEDOR  CORRECTO</font></td>
    <td bgcolor="#EDEDED"><font color="#000000" size="2"><strong><font color="#000000" size="2"><strong><font color="#000000" size="2">
      <input name="anio" type="text" id="anio" onKeyPress="return verif_caracter(this,event)"  size="6">
