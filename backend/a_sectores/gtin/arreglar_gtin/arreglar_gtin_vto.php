...
?>
<BODY onload = "on_load()">
<form action="arreglar_vto.php" method="post">
<table width="800" border="0">
  <!--DWLayoutTable-->
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E6E6E6"> 
    <td height="26" colspan="2" valign="top" bgcolor="#B8B8B8"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif"><strong><font color="#000000">ARREGLAR GTIN </font> </strong></font></div></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td width="26%" height="24" bgcolor="#EDEDED"> <div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">GTIN CON VTO ERRONEO </font></div></td>
    <td width="74%" bgcolor="#EDEDED"><div align="left"> <font color="#000000" size="2"><strong><font color="#000000" size="2"> 
        <input type="text" name="gtin"  size="80" id="gtin" onKeyPress="return verif_caracter(this,event)">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td height="24" bgcolor="#EDEDED"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">FECHA CORRECTA </font></td>
    <td bgcolor="#EDEDED"><font color="#000000" size="2"><strong><font color="#000000" size="2"><strong><font color="#000000" size="2">
      <strong><font color="#000000" size="2"><strong><font color="#000000" size="2">
      MES
      <input name="mes" type="text" id="mes" onKeyPress="return verif_caracter(this,event)"  size="2">
      </font></strong></font><font size="2"> </font><font color="#000000" size="2"> A&Ntilde;O</font></strong>/
      <input name="anio" type="text" id="anio" onKeyPress="return verif_caracter(this,event)"  size="2">
