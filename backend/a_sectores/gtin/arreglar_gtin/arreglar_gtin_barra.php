...
?>
<BODY onload = "on_load()">
<form action="arreglar_barra.php" method="post">
<table width="800" border="0">
  <!--DWLayoutTable-->
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E6E6E6"> 
    <td height="26" colspan="2" valign="top" bgcolor="#B8B8B8"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif"><strong><font color="#000000">ARREGLAR CODIGO DE BARRAS </font> </strong></font></div></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td width="34%" height="24" bgcolor="#EDEDED"> <div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">GTIN CON COD BARRA ERRONEO </font></div></td>
    <td width="66%" bgcolor="#EDEDED"><div align="left"> <font color="#000000" size="2"><strong><font color="#000000" size="2"> 
        <input type="text" name="gtin"  size="60" id="gtin" onKeyPress="return verif_caracter(this,event)">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E8DCFC"> 
    <td height="24" bgcolor="#EDEDED"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">COD BARRA  CORRECTO</font></td>
    <td bgcolor="#EDEDED"><font color="#000000" size="2"><strong><font color="#000000" size="2"><strong><font color="#000000" size="2">
      <input name="anio" type="text" id="anio" onKeyPress="return verif_caracter(this,event)"  size="40">
