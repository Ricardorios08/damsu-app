...
<body onload = "on_load ()">
<FORM ACTION="limpiar_temp.php" METHOD = "POST" enctype="multipart/form-data" name="form">



  <table width="800" border="0" cellspacing="0">
        <tr bgcolor="#000099">
          <td height="35" colspan="3" bgcolor="#CCCCCC"><div align="center" class="Estilo16 Estilo54">LIMPIAR TEMP </div></td>
        </tr>
        
        <tr bgcolor="#E8DCFC">
          <td bgcolor="#E6E6E6"><div align="right"><span class="Estilo59">GTIN</span></div></td>
          <td colspan="2" bgcolor="#E6E6E6"><input name="gtin" type="text" id="gtin" size="60"></td>
        </tr>
        <tr bgcolor="#E8DCFC">
          <td width="50%" bgcolor="#E6E6E6"><div align="right"><span class="Estilo59">CONTRASE&Ntilde;A DE SEGURIDAD </span></div></td>
          <td width="100%" colspan="2" bgcolor="#E6E6E6"><input name="seguridad" type="password" id="seguridad"></td>
        </tr>
