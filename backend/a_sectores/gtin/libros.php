...
<table width="154"  border="0">
  ...
  <tr>
    <td bgcolor="#666666"><div align="center" class="Estilo3">LIBROS</div></td>
  </tr>
</table>

<form action ="../facturacion/libro_iva/buscar_facturas.php" method="post" target ="central1">
  <table width="154"  border="0">
    <tr bgcolor="#990033"> </tr>
    <tr>
        ...
        <tr>
          <td colspan="2"><div align="center" class="Estilo16">
            <select name="tipo_libro[]" id="tipo_libro[]" onkeypress="return verif_caracter(this,event)">
			   ...
			   <option value="ace" selected >ENTREGAS ACE</option>
			   <option value="ace1"  >FACTURAS ACE</option>

			   <option value="ventas" >ENTREGAS.</option>
