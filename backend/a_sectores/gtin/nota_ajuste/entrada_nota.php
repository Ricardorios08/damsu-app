...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#000099">
    <td colspan="2" bgcolor="#CCCCCC"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">NOTAS DE AJUSTES POR PRECIOS</font></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#E6E6E6"><font face="Trebuchet MS">
      <select name="cod_movimiento" id="cod_movimiento">
        <option value="1">AJUSTE NEGATIVO (N/C)</option>
        <option value="2">AJUSTE POSITIVO(N/D)</option>
        </select>
    </font></td>
    </tr>
  
  <tr>
    <td bgcolor="#E6E6E6"><div align="right"><font color="#000000" size="2" face="Trebuchet MS">Importe</font></div></td>
    <td bgcolor="#E6E6E6"><font face="Trebuchet MS">
      <input type = "text" name = "importe" id="importe" size = "10" onKeyPress="return verif_caracter(this,event)">
