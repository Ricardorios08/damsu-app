...
$pdf->SetFont('ARIAL','',8);
  ...
  $sql = "SELECT * FROM `tr_ventas_encabezado15` where nro_factura = $nro_factura";
...
$pdf->ln();
 ...
 $sql3 = "SELECT * FROM `tr_ventas_detalle15`  WHERE  nro_factura = $nro_factura order by  cod_detalle desc";
