...
<html lang="es">
 ...
 <meta charset="utf-8">
<title>Programa Oncol&#65533;gico Mendoza</title>
 <!-- Bootstrap core CSS -->
...
<table width="803" border="0" cellspacing="0" class="table-striped">
  <tr bgcolor="#B9CAF0">
    <td height="45"><div align="center" class="Estilo3"><font face="Trebuchet MS">ENTREGA DE MEDICAMENTOS </font></div>      
    <div align="right"><font color="#000000" face="Trebuchet MS"> </font></div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td bgcolor="#CCCCCC"><div align="left">Paciente <?php echo $denominacion;?> (<?php echo $nro_proveedor;?>)</div>      <div align="right"> </td>
  </tr>
  
   <?php if ($bande_buscar == "SI"){?>
  <tr bgcolor="#F0F0F0">
    <td><div align="left"> COD BARRA 
     <input type = "text" name = "cod_mercaderia" id="cod_mercaderia" size = "15" value = "<?php echo $cod_mercaderia;?>"  onKeyPress="return verif_caracter(this,event)" style = "width: 25% !important;">
      ...
      <input name="Alta" type="submit" value="VER" id ="Alta" size = "10"  onload = "on_producto()" class="btn btn-warning">
   	</td>
  </tr> 
      <?php }else{?>
        <tr bgcolor="#F0F0F0">
  ...
  <tr bgcolor="#E8DCFC">
    ...
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
      <input type = "text" name = "mes_lote" id="mes_lote" size = "6" onKeyPress="return verif_caracter(this,event)" >
      /</font><font color="#000000" size="2"> 20
  <input name = "anio_lote" type = "text" id="anio_lote" onKeyPress="return verif_caracter(this,event)" size = "6" maxlength="2" >
</font></div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
...
echo"<option value=$cod_droga>$droga ($cod_droga)</option>";
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
    <td bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS"> 
      <input type="text" class="form-control" name="presentacion" id="presentacion"   placeholder="Presentaci&oacute;n" size="30"onKeyPress="return verif_caracter(this,event)">
...
echo"<option value=$cod_laboratorio>$laboratorio ($cod_laboratorio)</option>";
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
    <td bgcolor="#E6E6E6"><font size="2" face="Trebuchet MS"> 
      <input type="text" name="cod_barra"  placeholder="C&oacute;digo 
...
<table width="800" border="0" cellspacing="0" onload = "on_producto()">
 <tr bgcolor="#B9CAF0">
  ...
  <tr bgcolor="#F0F0F0">
    ...
    <td width="15%" colspan="2"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">A&Ntilde;O</font></div></td>
