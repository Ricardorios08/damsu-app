...
<table width="800" border="0" cellspacing="0" class="table-striped">
  <tr bgcolor="#FFBC79">
...
?><tr bgcolor="#FFFFFF" >
    ...
    <td width="5%" bgcolor="#FFFFFF" class="Estilo6" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center" class="Estilo14">   <a href="borrar_item.php?cod_detalle=<?php print("$cod_detalle");?>&&id=<?php print("$id");?>&&transaccion=<?php print("$transaccion");?>&&prestador=<?php print("$prestador");?>&&gln=<?php print("$gln");?>"><IMG SRC="../../../imagenes/botones/btn_anular.gif" alt="Anular" border = "0"></a></div></td>
  </tr>
<?php 
...
<tr bgcolor="#E6E6E6">
  <td colspan="8" scope="col"><div align="right" class="Estilo12"><BLINK>
    ...
    <div align="center"><span class="Estilo28 Estilo13 Estilo7"><strong>
      ...
      <A HREF="actualizar_stock.php?id=<?php print("$id");?>" class="btn btn-success">GENERAR NOTA DE ENTREGA</A> 
      
	  


      <a href="informe.php?id=<?php print("$id");?>" class="btn btn-warning">PREVIZUALIZAR</A> 
