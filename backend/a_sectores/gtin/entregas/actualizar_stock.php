...
$documento=strtoupper($result3->fields["nro_proveedor"]);
...
$gln_proveedor=strtoupper($result3->fields["gln_proveedor"]);
...
$nombre=strtoupper($result8->fields["nombre"]);
  $nombre_completo=$apellido." ".$nombre;
    ...
    $sql="select * from usuario where id = '$gln_proveedor' ";
$result = $db->Execute($sql);
  $nombre_prestador=strtoupper($result->fields["nombre_usuario"]);

$boca = str_pad($gln_proveedor, 3, "0", STR_PAD_LEFT);
...
//mysql_query($sql);
 ...
 $sql = "INSERT INTO `tr_ventas_detalle` ( `tipo_fact` , `nro_factura` , `cod_detalle` , `cod_mercaderia` , `descripcion` , `presentacion` , `lote` , `mes_lote` , `anio_lote` , `cantidad` , `precio_unitario` , `total` , `proveedor` , `operador` , `gtin` , `resultado` , `transaccion` , `nro_serie`)  VALUES ('$boca' , '$idgenerado' , '' ,'$cod_mercaderia' , '$nombre_comercial', '$presentacion' , '$lote' , '$mes_lote' , '$anio_lote' , '1' , '$precio_unitario' , '$precio_unitario' , '$proveedor' , '$operador' , '$gtin' , '$gln_proveedor' , '' , '$nro_serie')";
mysql_query($sql);
