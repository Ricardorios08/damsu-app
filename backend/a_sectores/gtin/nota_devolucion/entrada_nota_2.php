...
$sql = "INSERT INTO `nota_devolucion` (`operador`, `fecha`, `nro_factura_afectada`, `importe`, `observaciones`) VALUES ('$operador', '$fecha', '$nro_factura_afectada', '$importe', '$observaciones')";
$result = $db->Execute($sql);
