...
$pdf->SetFont('ARIAL','',8);
 ...
 $sql = "SELECT * FROM compras_encabezado15 where nro_factura = $nro_factura";
...
$pdf->Cell(50,5,"TOTAL",0,1,'L'); 
 ...
 $sql3 = "SELECT * FROM compras_detalle15  WHERE  nro_factura = $nro_factura order by cod_detalle desc";
$result3 = $db->Execute($sql3);

if (!$result3) die("fallo1111".$db->ErrorMsg());
