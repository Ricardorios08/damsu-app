...
if ($nro_factura != ""){
$sql = "SELECT * FROM `tr_compras1_deta_temp`  WHERE  `nro_factura` = $nro_factura and operador = $id";
}
...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#FFBC79">
    ...
    <td width="9%" bgcolor="#CCCCCC" scope="col"><div align="center" class="Estilo26 Estilo13 Estilo7">ANMAT</div></td>
...
?><tr bgcolor="#FFFFFF" >
    ...
    <td bgcolor="#FFFFFF" scope="col" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center" class="Estilo14"><span class="Estilo26"><?php echo $resultado;?> <?php echo $transaccion;?></span></div></td>
    ...
    <td width="5%" bgcolor="#FFFFFF" class="Estilo6" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center" class="Estilo14">   <a href="borrar_item.php?cod_detalle=<?php print("$cod_detalle");?>&&id=<?php print("$id");?>&&transaccion=<?php print("$transaccion");?>"><IMG SRC="../../../imagenes/botones/btn_anular.gif" alt="Anular" border = "0"></a></div></td>
  </tr>
<?php 
...
<tr bgcolor="#E6E6E6">
  <td colspan="8" scope="col"><div align="right" class="Estilo12"><BLINK>
    <div align="center">Presione actualizar para guardar la compra o imprimir Informe </div>
  </BLINK></div>    
    <div align="center"><span class="Estilo28 Estilo13 Estilo7"><strong>
      
      
      <A HREF="actualizar_stock.php?id=<?php print("$id");?>"><IMG SRC="../../../imagenes/botones/stock.png" alt="Imprimir" border = "0"></A> 
      
      <a href="informe.php?id=<?php print("$id");?>"><IMG SRC="../../../imagenes/botones//btn_imprimir.gif" alt="Imprimir" border = "0"></a>
