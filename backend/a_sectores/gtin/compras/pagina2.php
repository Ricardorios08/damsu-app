...
echo $sql = "DELETE from compras1_encab_temp where operador = $id";
$result = $db->Execute($sql);
echo  $sql = "DELETE from compras1_deta_temp where operador = $id";
$result = $db->Execute($sql);
...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#000099">
    <td height="27" colspan="4" bgcolor="#990000"><div align="center"><font color="#FFFFFF" face="Trebuchet MS">a INGRESO DE MEDICAMENTOS ANMAT </font></div></td>
  ...
  <tr bgcolor="#E1F2EF">
    <td colspan="4" bgcolor="#CCCCCC"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"> Proveedor: </font>        <font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"> <?php echo $denominacion;?> (<?php echo $nro_proveedor;?>) &nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif">Fecha/Compra: </font><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><?php echo $fecha1;?> &nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"></div></td>
    <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">N&ordm; Comprobante:</font> <font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><?php echo $nro_factura;?></font></div></td>
  </tr>
