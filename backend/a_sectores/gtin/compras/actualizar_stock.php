...
$tipo=strtoupper($result7->fields["tipo"]);
 ...
 $sql = "INSERT INTO `tr_existencias` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `lote` ,  `mes_lote` , `anio_lote` , `cantidad_ingresada` , `precio_unitario` , `cantidad_salida` , `fecha_ultimo_mov` , `proveedor` , `gtin` , `transaccion` , `nro_serie` , `cod_droga`  , `grupo`  , `laboratorio`  )  VALUES ('$nro_factura' , '' ,'$cod_mercaderia' , '$lote' , '$mes_lote' , '$anio_lote', '$cantidad_ingresada' , '$precio_unitario' , '' , '$fecha_ultimo_mov' ,  '$nro_proveedor' , '$gtin' , '$transaccion' , '$nro_serie' , '$cod_droga' , '$grupo' , '$laboratorio')";
mysql_query($sql);
...
*/
  ...
  $sql = "INSERT INTO `tr_stock` ( `cod_mercaderia` , `fecha` , `cod_movimiento` , `tipo_fact` , `nro_comprobante` , `cantidad` , `precio_unitario` , `lote` ,  `mes_lote` , `anio_lote` , `cuenta` , `tipo_cuenta` ,  `cod_operacion`, `observaciones`, `documento`, `cod_droga`, `nro_os`, `gtin`, `transaccion`, `nro_serie` , `drogas` , `grupo` , `laboratorio`) VALUES ('$cod_mercaderia' , '$fecha_ultimo_mov' , '1' ,  'A' , '$nro_factura' , '$cantidad_ingresada' , '$precio_unitario' , '$lote' , '$mes_lote', '$anio_lote' , '$nro_proveedor' , '1' , '' , '', '' , '$cod_droga' , '' ,  '$gtin' , '$transaccion' , '$nro_serie' , '$drogas' , '$grupo' , '$laboratorio')";
mysql_query($sql);
