...
$fecha_ultimo_mov= $result2->fields["fecha_ultimo_mov"]; 
 ...
 $sql3 = "SELECT sum(cantidad_ingresada) as cantidad_ingresada, sum(cantidad_salida) as cantidad_salida  FROM `existencia_ago` where cod_mercaderia = '$cod_merca' and anio_lote = '$anio_lote' and mes_lote = '$mes_lote' and lote = '$lote'";
