...
if ($provee == 1){
$titulo = "ASOC. COOP. HOSPITAL CENTRAL - INVENTARIO DE MEDICAMENTOS AL ".$dia."-".$mes."-".$anio. " (ACddE)";
}else{
$titulo = "ASOC. COOP. HOSPITAL CENTRAL - INVENTARIO DE MEDICAMENTOS AL ".$dia."-".$mes."-".$anio. " (COMPLETO)";
}
$pdf->AddPage();
...
$pdf->Cell(20,5,'DROGA',1,0,'C');  
$pdf->Cell(50,5,'NOMBRE',1,0,'C'); 
$pdf->Cell(50,5,'PRESENTACION',1,0,'C'); 
$pdf->Cell(13,5,'X CAJA',1,0,'C'); 
$pdf->Cell(27,5,'LABORATORIO',1,0,'C'); 
$pdf->Cell(10,5,"ANT",1,0,'C');  
$pdf->Cell(10,5,"ENT",1,0,'C');  
$pdf->Cell(10,5,"SALI",1,0,'C'); 
$pdf->Cell(15,5,"SALDO",1,0,'C'); 
$pdf->Cell(20,5,"ANT",1,0,'C'); 
$pdf->Cell(20,5,"ENT",1,0,'C'); 
$pdf->Cell(20,5,"SALI",1,0,'C'); 
...
$saldo_real = $anterior + $cantidad - $salida;
...
$pdf->Cell(30,5,$laboratorio,1,0,'C'); 
 $pdf->SetTextColor(0);
}
else
	  {
...
$pdf->Cell(10,5,$anterior,1,0,'C'); 
$pdf->Cell(10,5,$cantidad,1,0,'C');
$pdf->Cell(10,5,$salida,1,0,'C');
$pdf->Cell(15,5,$saldo_real,1,0,'C');
$pdf->Cell(20,5,$anterior_valor,1,0,'R');
$pdf->Cell(20,5,$entradas_valor,1,0,'R');
$pdf->Cell(20,5,$salidas_valor,1,0,'R');
$pdf->Cell(20,5,$saldo_valor,1,0,'R'); 
