...
if (($mes == 05) and ($anio == 15)){
$tr_existencias = "tr_existencias_30052015";
}elseif (($mes == 06) and ($anio == 15)){
$tr_existencias = "tr_existencias_30062015";
}elseif (($mes == 07) and ($anio == 15)){
$tr_existencias = "tr_existencias_30072015";
}elseif (($mes == 08) and ($anio == 15)){
$tr_existencias = "tr_existencias_30082015";
}elseif (($mes == 09) and ($anio == 15)){
$tr_existencias = "tr_existencias_30092015";
}elseif (($mes == 10) and ($anio == 15)){
$tr_existencias = "tr_existencias_30102015";
}elseif (($mes == 11) and ($anio == 15)){
$tr_existencias = "tr_existencias_30112015";
}elseif (($mes == 12) and ($anio == 15)){
$tr_existencias = "tr_existencias_30122015";
}elseif (($mes == 01) and ($anio == 16)){
$tr_existencias = "tr_existencias_30012016";
}elseif (($mes == 02) and ($anio == 16)){
$tr_existencias = "tr_existencias_30022016";
}elseif (($mes == 03) and ($anio == 16)){
$tr_existencias = "tr_existencias_30032016";
}
...
$titulo = "ASOC. COOP. HOSPITAL CENTRAL - INVENTARIO DE MEDICAMENTOS AL 30-".$mes."-".$anio;
$pdf->AddPage();
...
$cantidad_agrupado=strtoupper($result->fields["cantidad"]);
  ...
  $sql="select sum(cantidad_ingresada - cantidad_salida) as existe from $tr_existencias where cod_mercaderia = $cod_barra";
$result = $db->Execute($sql);
