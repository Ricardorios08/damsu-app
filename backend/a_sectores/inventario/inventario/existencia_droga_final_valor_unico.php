...
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
}elseif (($mes == 10) and ($anio == 13) or ($mes == 10) and ($anio == 13) ){
...
$monodrogas = "monodrogas_3008202014";
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
...
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
}elseif (($mes == 10) and ($anio == 14) or ($mes == 10) and ($anio == 14)){
$monodrogas = "monodrogas_30102014";
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
}elseif (($mes == 11) and ($anio == 14) or ($mes == 11) and ($anio == 14)){
$monodrogas = "monodrogas_30112014";
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
}elseif (($mes == 12) and ($anio == 14) or ($mes == 12) and ($anio == 14)){
$monodrogas = "monodrogas_30122014";
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";


}elseif (($mes == 01) and ($anio == 15) or ($mes == 1) and ($anio == 15)){
$monodrogas = "monodrogas_30012015";
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";


}elseif (($mes == 02) and ($anio == 15) or ($mes == 2) and ($anio == 15)){
$monodrogas = "monodrogas_30012015";
$tr_stock_provisorio = "tr_stock_temp_provisorio";
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
...
$tr_stock_provisorio1 = "tr_stock_temp_provisorio1";
    ...
    $sql1="select * from $tr_stock_provisorio1 where mes = '$mes' and anio = '$anio' order by cod_mercaderia";
...
$sql="select * from stock_inventario where cod_mercaderia = $cod_barra";
$result = $db->Execute($sql);
...
if ($total_inv < 0){
 $pdf->SetTextColor(5,0,180);
$pdf->Cell(10,5,$total_inv,1,0,'L'); 
 $pdf->SetTextColor(0);
}
else
	  {
...
$pdf->ln();
$pdf->SetX(20);
$pdf->Cell(20,5,"EXISTENCIA: ",0); 
$pdf->Cell(10,5,$to_exi,0);  


$pdf->SetX(100);
$pdf->Cell(20,5,"INVENTARIO: ",0); 
$pdf->Cell(10,5,$to_ingresos,0);  
...
$pdf->SetX(150);
$pdf->Cell(10,5,"DIF: ",0); 
$pdf->Cell(10,5,number_format($acum,2),0);  
