...
?><tr bgcolor="#FFFFFF" >
    ...
    <td width="5%" bgcolor="#FFFFFF" class="Estilo6" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center" class="Estilo14">   <a href="borrar_item.php?cod_detalle=<?php print("$cod_detalle");?>&&cod_mercaderia=<?php print("$cod_mercaderia");?>&&transaccion=<?php print("$transaccion");?>"><IMG SRC="../../../../imagenes/botones/btn_anular.gif" alt="Anular" border = "0"></a></div></td>
  </tr>
<?php 
