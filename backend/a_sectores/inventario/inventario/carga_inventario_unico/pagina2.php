...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#000099">
    <td height="27" colspan="4" bgcolor="#990000"><div align="center"><font color="#FFFFFF" face="Trebuchet MS">INVENTARIO INICIAL UNICO</font></div></td>
    <td width="45%" height="27" bgcolor="#990000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS"> <?php echo $nombre_usuario;?></font></div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td colspan="4" bgcolor="#CCCCCC"><div align="left"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif">Fecha: </font><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><?php echo $fecha1;?> &nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"></div></td>
    <td bgcolor="#CCCCCC"><div align="right"></div></td>
  </tr>
  
  <tr bgcolor="#E8DCFC">
    <td colspan="5" bgcolor="#E6E6E6"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong>
      
        <font color="#000000" size="2" face="Arial, Helvetica, sans-serif">COD UNICO </font><font color="#006600">
...
$sql="select denominacion from proveedores where cod_proveedor = $nro_proveedor";
$result8 = $db->Execute($sql);
$denominacion=strtoupper($result8->fields["denominacion"]);

if ($denominacion == ""){
$leyenda = "NO EXISTE ESE PROVEEDOR";
	INCLUDE ("../../../../alertas/campo_informacion2.php");
	exit;
}
...
<table width="800" border="0" cellspacing="0" onload = "on_producto()">
 <tr bgcolor="#E8DCFC">
    <td colspan="6" bgcolor="#E6E6E6"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#006600">
  ...
  <tr bgcolor="#E8DCFC">
    <td width="15%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">CANT</font></div></td>
    <td width="15%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">PRECIO UNIT. </font></div></td>
    <td width="24%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">LOTE</font></div></td>
    <td width="20%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">VTO MES / A&Ntilde;O</font></div></td>
    <td width="15%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">N&deg; PROVEEDOR </font></div></td>
    <td width="11%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">AGREGAR</font></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
    <td bgcolor="#E6E6E6"><div align="center">
      <input type = "text" name = "gtin" id="gtin" onKeyPress="return verif_caracter(this,event)" tabindex = "2" size = "4">
    </div></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
        <input type = "text" name = "precio_unitario" id="precio_unitario" size = "5" value = "<?php echo $precio_actualizado;?>" onKeyPress="return verif_caracter(this,event)" >
    </font></div></td>
    <td bgcolor="#E6E6E6"><font color="#000000" size="2">
      <input type = "text" name = "lote" id="lote" size = "30" onKeyPress="return verif_caracter(this,event)">
    </font></td>
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
        <input type = "text" name = "mes_lote" id="mes_lote" size = "2" onKeyPress="return verif_caracter(this,event)" >
      /</font><font color="#000000" size="2"> 20
    ...
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
      <input name = "proveedor" type = "text" id="proveedor" onKeyPress="return verif_caracter(this,event)" value="900" size = "10" >
    </font></div></td>
    <td bgcolor="#E6E6E6"><div align="center">
        <input name="Alta" type="submit" value="SI" id ="SI" size = "10" >
        <font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#006600">
