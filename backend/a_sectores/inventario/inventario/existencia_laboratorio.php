...
$pdf->ln();
 ...
 echo $sql8="select * from tr_stock where cod_movimiento = 1 and fecha  = '2012-10-31' group by cod_mercaderia, laboratorio order by drogas, cod_droga";
$result8 = $db->Execute($sql8);
  ...
  $cod_merca=strtoupper($result8->fields["cod_mercaderia"]);

 $precio_unitario=strtoupper($result8->fields["precio_unitario"]);
  $proveedor=strtoupper($result8->fields["proveedor"]);
  $cantidad1=strtoupper($result8->fields["cantidad"]);
...
$droga=strtoupper($result->fields["droga"]);
 ...
 $sql="select * from monodrogas where cod_barra = $cod_merca";
$result = $db->Execute($sql);
...
$sql="select sum(cantidad) as cantidad from tr_stock where cod_mercaderia = $cod_merca and cod_movimiento = 1 and fecha = '2012-10-31'";
$result = $db->Execute($sql);
...
$pdf->Cell(25,5,$cod_merca,0); 
$pdf->Cell(10,5,$cod_droga,0); 

$pdf->Cell(50,5,$nombre_comercial,0);
$pdf->Cell(50,5,$laboratorio,0);

$pdf->Cell(50,5,$droga,0); 
$pdf->Cell(50,5,$presentacion,0); 

$pdf->Cell(10,5,$cantidad1,0); 
$pdf->Cell(15,5,number_format($precio_unitario,2),0,0,'R'); 
