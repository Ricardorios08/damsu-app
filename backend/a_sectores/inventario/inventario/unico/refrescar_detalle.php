...
$sql = "SELECT * FROM stock_inventario order by cod_operacion desc";
...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#FFBC79">
    ...
    <td width="30%"  bgcolor="#CCCCCC" scope="col"><div align="center"><span class="Estilo28 Estilo13 Estilo7">Cantidad</span></div></td>
...
?><tr bgcolor="#FFFFFF" >
    ...
    <td bgcolor="#FFFFFF" scope="col" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center"><span class="Estilo14"><span class="Estilo28 Estilo6"><?php echo $cantidad;?></span></span></div></td>
    ...
    <td width="8%" bgcolor="#FFFFFF" class="Estilo6" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center" class="Estilo14">   <a href="borrar_item.php?cod_operacion=<?php print("$cod_operacion");?>"><IMG SRC="../../../../../imagenes/botones/btn_anular.gif" alt="Anular" border = "0"></a></div></td>
  </tr>
<?php 
