...
<table width="800" border="0" cellspacing="0">
  <tr bgcolor="#000099">
    <td height="27" colspan="4" bgcolor="#990000"><div align="center"><font color="#FFFFFF" face="Trebuchet MS">INVENTARIO INICIAL</font></div></td>
...
echo "*".$dia= $_REQUEST['dia'];
echo "*".$mes= $_REQUEST['mes'];
echo "*".$anio= $_REQUEST['anio'];
...
<table width="800" border="0" cellspacing="0" onload = "on_producto()">
 <tr bgcolor="#E8DCFC">
  ...
  <tr bgcolor="#E8DCFC">
    <td colspan="5" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">GTIN</font></div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
  ...
  <tr bgcolor="#E8DCFC">
    ...
    <td width="17%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">VTO MES / A&Ntilde;O</font></div></td>
    <td width="19%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">N&deg; PROVEEDOR </font></div></td>
    <td width="8%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">AGREGAR</font></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
        <input type = "text" name = "precio_unitario" id="precio_unitario" size = "5" value = "<?php echo $precio_actualizado;?>" onKeyPress="return verif_caracter(this,event)" >
    ...
    <td bgcolor="#E6E6E6"><div align="center"><font color="#000000" size="2">
      <input name = "proveedor" type = "text" id="proveedor" onKeyPress="return verif_caracter(this,event)" size = "10" value = "110">
    </font></div></td>
    <td bgcolor="#E6E6E6"><div align="center">
        <input name="Alta" type="submit" value="SI" id ="SI" size = "10" >
        <font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#006600">
...
$id= $_REQUEST['id'];
$informar= $_REQUEST['informar'];
echo "----".$proveedor= $_REQUEST['proveedor'];
