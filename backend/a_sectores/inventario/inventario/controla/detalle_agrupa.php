...
include ("agrupa.php");
$sql = "SELECT * FROM inventario_agrupado order by drogas";
...
<table width="918" border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#FFBC79">
    ...
    <td width="3%" bgcolor="#CCCCCC" class="Estilo28" scope="col"><div align="center" class="Estilo14"><span class="Estilo13">INV</span></div></td>
  </tr><?php 
...
?><tr bgcolor="#FFFFFF" >
    ...
    <td width="3%" bgcolor="#FFFFFF" class="Estilo6" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)"><div align="center" class="Estilo14"><span class="Estilo28"><?php echo $cantidad;?></span></div></td>
  </tr>
<?php 
