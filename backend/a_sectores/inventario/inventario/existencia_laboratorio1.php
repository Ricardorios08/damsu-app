...
$pdf->ln();
 ...
 $sql8="select * from tr_stock where cod_movimiento = 1 and fecha  = '2012-10-31' group by laboratorio order by drogas, cod_droga";
...
$sql1="select * from tr_stock where cod_movimiento = 1 and fecha  = '2012-10-31' and laboratorio = '$laboratorio'";
