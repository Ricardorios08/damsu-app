...
$titulo = "ASOC. COOP. HOSPITAL CENTRAL - INVENTARIO DE MEDICAMENTOS  AL 31-".$mes."-".$anio." (UNICO) ";
$pdf->AddPage();
...
$sql1="select * from $tr_stock_provisorio1 where mes = '$mes' and anio = '$anio' order by drogas";
...
$sql="select * from $monodrogas where troquel = $cod_barra";
$result = $db->Execute($sql);
...
$pdf->Cell(50,5,number_format($tot,2),0);  
