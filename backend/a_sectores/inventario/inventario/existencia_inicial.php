...
$titulo = "ASOC. COOP. HOSPITAL CENTRAL - INVENTARIO DE MEDICAMENTOS AL 31-".$mes."-".$anio;
$pdf->AddPage();
...
switch ($por){
	case "1":{$orden = "drogas, laboratorio";break;}
	case "2":{$orden = "nombre_comercial, laboratorio";break;}
}


 $sql1="select * from tr_stock_temp_provisorio where mes = '$mes' and anio = '$anio' order by $orden";
...
$pdf->Cell(20,5,$precio_uni,1,0,'R'); 
//$pdf->Cell(20,5,number_format($saldo,2),0); 
$pdf->Cell(20,5,number_format($saldo,2),1,0,'R'); 
...
$pdf->ln();
$pdf->SetX(100);
$pdf->Cell(50,5,"INGRESOS: ",0); 
$pdf->Cell(50,5,number_format($suma_ingresos,2),0); 
$pdf->ln();

$pdf->SetX(100);
$pdf->Cell(50,5,"Egresos: ",0); 
$pdf->Cell(50,5,number_format($suma_egresos,2),0); 
...
$pdf->SetX(100);
$pdf->Cell(50,5,"Egresos: ",0); 
$pdf->Cell(50,5,number_format($suma_saldo,2),0);  
