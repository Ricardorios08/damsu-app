...
<FORM ACTION="../../validar/usuarios/guardar_empleado.php" method="post" TARGET = "central1">


  <table width="800" height="314" border="0">
      <tr bgcolor="#E6E6E6">
        <td height="24" colspan="2" bgcolor="#B8B8B8"><div align="center">INGRESO EMPLEADO </div></td>
      </tr>
      <tr>
        <td width="47%" height="24"><div align="right">Apellido</div></td>
      ...
      <tr>
        <td height="24" colspan="2">          <div align="center">
          <input type="Submit" name="bLogin" value="Guardar Contacto" id="guardar">
          </div></td>
    </tr>
  </table>
</form>
